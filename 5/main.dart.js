...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, null, null, 14, 0, null, 34, 36, 39, 17, 18, 31, 55],
    ...
    Future_Future: function(computation, $T) {
      ...
      P.Timer_Timer(C.Duration_0, new P.closure2(computation, result));
      return result;
    },
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 64, 9],
    _nullErrorHandler: [function(error, stackTrace) {
      $.Zone__current.handleUncaughtError$2(error, stackTrace);
    }, function(error) {
      return P._nullErrorHandler(error, null);
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 9, 5, 6, 7],
    ...
    }, "call$5", "async___rootHandleUncaughtError$closure", 10, 0, 20],
    ...
    _rootErrorCallback: [function($self, $parent, zone, error, stackTrace) {
      return;
    }, "call$5", "async___rootErrorCallback$closure", 10, 0, 65],
    ...
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 70, 1, 2, 3, 44, 38],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 9, 5, 6, 7],
    ...
    _Future__chainForeignFuture_closure0: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 5, 6, 7, "call"]
    },
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 37, 6, 7],
    ...
    IterableMixin: {
      ...
      forEach$1: function(_, f) {
        var t1;
        for (t1 = J.get$iterator$ax(this._results); t1.moveNext$0();)
          f.call$1(t1.get$current());
      },
      join$1: function(_, separator) {
        var iterator, t1;
        iterator = J.get$iterator$ax(this._results);
      ...
      get$length: function(_) {
        var it, count;
        it = J.get$iterator$ax(this._results);
        for (count = 0; it.moveNext$0();)
          ++count;
        return count;
      },
      get$isEmpty: function(_) {
        return !J.get$iterator$ax(this._results).moveNext$0();
      },
      get$isNotEmpty: function(_) {
        return J.get$iterator$ax(this._results).moveNext$0();
      },
      get$first: function(_) {
        var it = J.get$iterator$ax(this._results);
        if (!it.moveNext$0())
          throw H.wrapException(H.IterableElementError_noElement());
    ...
    }, "call$1", "convert___defaultToEncodable$closure", 2, 0, 1, 25],
    Codec: {
      "^": "Object;$ti"
    },
    Converter: {
    ...
    DomIterator: {
      ...
      }, "next$0", "call$1", "call$0", "get$next", 0, 2, 56],
      "%": "Iterator"
    },
    DomRectReadOnly: {
      "^": "Interceptor;",
    ...
    EventTarget: {
      ...
      $isEventTarget: 1,
      "%": "AnalyserNode|AudioBufferSourceNode|AudioChannelMerger|AudioChannelSplitter|AudioContext|AudioDestinationNode|AudioGainNode|AudioNode|AudioPannerNode|AudioSourceNode|BatteryManager|BiquadFilterNode|BluetoothDevice|BluetoothRemoteGATTCharacteristic|CanvasCaptureMediaStreamTrack|ChannelMergerNode|ChannelSplitterNode|ConvolverNode|CrossOriginServiceWorkerClient|DelayNode|DynamicsCompressorNode|GainNode|IIRFilterNode|JavaScriptAudioNode|MIDIAccess|MediaElementAudioSourceNode|MediaKeySession|MediaQueryList|MediaSource|MediaStream|MediaStreamAudioDestinationNode|MediaStreamAudioSourceNode|MediaStreamTrack|MessagePort|NetworkInformation|OfflineAudioContext|Oscillator|OscillatorNode|PannerNode|Performance|PermissionStatus|PresentationReceiver|PresentationRequest|RTCDTMFSender|RTCPeerConnection|RealtimeAnalyserNode|ScreenOrientation|ScriptProcessorNode|ServicePortCollection|ServiceWorkerContainer|ServiceWorkerRegistration|StereoPannerNode|USB|WaveShaperNode|WorkerPerformance|mozRTCPeerConnection|webkitAudioContext|webkitAudioPannerNode|webkitRTCPeerConnection;EventTarget;EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin|EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin1|EventTarget_ListMixin1|EventTarget_ListMixin_ImmutableListMixin0"
    },
    FieldSetElement: {
      "^": "HtmlElement;name%",
      "%": "HTMLFieldSetElement"
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 71, 14],
    ...
    }, "call$0", "modules__createEventPlugins$closure", 0, 0, 72],
    createNgZone: [function() {
      return Y.NgZone$(false);
    }, "call$0", "modules__createNgZone$closure", 0, 0, 73],
    ...
    }, "call$0", "modules__createRandomAppId$closure", 0, 0, 18],
    ...
    NgIf: {
      ...
      set$ngIf: function(newCondition) {
        ...
        if (newCondition) {
          t1.toString;
          t1.attachView$2(this._ng_if$_templateRef.createEmbeddedView$0().appView, t1.get$length(t1));
        } else
          t1.clear$0(0);
    ...
    initReflector41: function() {
      ...
      t1.$indexSet(0, C.Type_PlatformRefImpl_Eok, new R.initReflector_closure15());
      t1.$indexSet(0, C.Type_ApplicationRefImpl_oqh, new R.initReflector_closure16());
    ...
    initReflector_closure16: {
      ...
      }, null, null, 6, 0, null, 8, 15, 26, "call"]
    }
    ...
    AppView: {
      ...
      project$2: function(parentElement, index) {
        var projectableNodes, projectables, i, projectable;
        ...
        for (i = 0; i < 1; ++i) {
          ...
          parentElement.appendChild(projectable);
        }
        $.domRootRendererIsDirty = true;
      },
    ...
    initReflector63: function() {
      ...
      K.initReflector90();
      V.initReflector45();
      $.$get$_factories().$indexSet(0, C.Type_AppViewUtils_NWH, new V.initReflector_closure12());
    ...
    initReflector64: function() {
      ...
      T.initReflector84();
      K.initReflector85();
      $.$get$_factories().$indexSet(0, C.Type_ComponentLoader_7xV, new B.initReflector_closure11());
    },
    ...
    initReflector65: function() {
      ...
      V.initReflector46();
      Q.initReflector54();
      $.$get$_factories().$indexSet(0, C.Type_ComponentResolver_r9K, new Y.initReflector_closure10());
    },
    ...
    initReflector66: function() {
      ...
      Y.initReflector65();
      K.initReflector85();
      $.$get$_factories().$indexSet(0, C.Type_SlowComponentLoader_qxe, new B.initReflector_closure9());
  ...
  }], ["", "package:angular/src/core/linker/query_list.dart",, D, {
    "^": "",
    ...
    QueryList: {
      "^": "Object_IterableMixin;_dirty,_results,_streamController,$ti",
      get$iterator: function(_) {
        return J.get$iterator$ax(this._results);
      },
      get$length: function(_) {
        return J.get$length$asx(this._results);
      },
      get$first: function(_) {
        return J.get$isNotEmpty$asx(this._results) ? J.get$first$ax(this._results) : null;
      },
      toString$0: function(_) {
        return J.toString$0$(this._results);
      },
      reset$1: [function(_, newList) {
        var t1, itemCount, i, results;
        t1 = J.getInterceptor$asx(newList);
        itemCount = t1.get$length(newList);
        if (typeof itemCount !== "number")
          return H.iae(itemCount);
        i = 0;
        for (; i < itemCount; ++i)
          if (!!J.getInterceptor(t1.$index(newList, i)).$isList) {
        ...
        this._dirty = false;
      }, "call$1", "get$reset", 2, 0, function() {
        return H.computeSignature(function(T) {
          return {func: 1, v: true, args: [[P.List, T]]};
        }, this.$receiver, "QueryList");
      }, 61]
    },
    ...
    RenderComponentType: {
      ...
      _flattenStyles$3: function(compId, styles, target) {
        var styleCount, i, style, t1;
        styleCount = styles.length;
        for (i = 0; i < styleCount; ++i) {
          style = styles[i];
          t1 = $.$get$COMPONENT_REGEX();
          target.push(H.stringReplaceAllUnchecked(style, t1, compId));
        }
        return target;
      }
    }
    ...
    initReflector43: function() {
      ...
      V.initReflector46();
      var t1 = $.$get$_factories();
      t1.$indexSet(0, C.Type_Testability_h8g, new F.initReflector_closure13());
      $.$get$_dependencies().$indexSet(0, C.Type_Testability_h8g, C.List_List_Type_NgZone_6ty);
      t1.$indexSet(0, C.Type_TestabilityRegistry_IMm, new F.initReflector_closure14());
    },
    ...
    NgZone: {
      ...
      }, "call$4", "get$_ng_zone$_scheduleMicrotask", 8, 0, 19, 1, 2, 3, 10],
      ...
      }, "call$5", "get$_onErrorWithoutLongStackTrace", 10, 0, 20, 1, 2, 3, 6, 49],
      ...
      }, "call$5", "get$_createTimer", 10, 0, 49, 1, 2, 3, 50, 10],
    ...
    WrappedTimer: {
      ...
      get$tick: function() {
        throw H.wrapException(new P.UnimplementedError("tick"));
      },
      tick$0: function() {
        return this.get$tick().call$0();
      }
    },
    NgZoneError: {
      "^": "Object;error>,stackTrace<"
    ...
    _RuntimeInjector: {
      ...
      useClass$2$deps: [function(clazz, deps) {
        ...
        return t1;
      }, null, "get$useClass", 2, 3, null, 5, 51, 52]
    },
    _FlatProviders: {
    ...
    BrowserExceptionHandler: {
      ...
      }, "call$2", null, null, null, "get$$call", 2, 4, null, 5, 5, 6, 53, 54],
      $isFunction: 1
    }
    ...
    initReflector68: function() {
      ...
      $._visited69 = true;
      N.initReflector37();
      $.$get$_factories().$indexSet(0, C.Type_BrowserExceptionHandler_zbo, new O.initReflector_closure8());
    },
    ...
    PublicTestability: {
      ...
      }, "call$1", "get$whenStable", 2, 0, 7, 13],
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 52, 5, 5, 16, 56, 57],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 58, 16, 22, "call"]
    },
    ...
    initReflector69: function() {
      ...
      V.initReflector45();
      V.initReflector76();
      $.$get$_factories().$indexSet(0, C.Type_DomEventsPlugin_B8J, new M.initReflector_closure7());
    },
    ...
    initReflector45: function() {
      ...
      V.initReflector46();
      O.initReflector47();
      $.$get$_factories().$indexSet(0, C.Type_EventManager_hsx, new V.initReflector_closure2());
    ...
    initReflector70: function() {
      ...
      O.initReflector47();
      var t1 = $.$get$_factories();
      t1.$indexSet(0, C.Type_HammerGestureConfig_gc6, new Z.initReflector_closure5());
      t1.$indexSet(0, C.Type_HammerGesturesPlugin_qFt, new Z.initReflector_closure6());
    ...
    initReflector71: function() {
      ...
      V.initReflector45();
      V.initReflector46();
      $.$get$_factories().$indexSet(0, C.Type_KeyEventsPlugin_zxt, new U.initReflector_closure4());
    },
    ...
    initReflector73: function() {
      ...
      T.initReflector72();
      O.initReflector74();
      $.$get$_factories().$indexSet(0, C.Type_DomSanitizationServiceImpl_4MH, new D.initReflector_closure3());
    },
  ...
  }], ["", "package:lifecycle_hooks/app_component.dart",, Q, {
    "^": "",
    AppComponent: {
      "^": "Object;"
    }
  }], ["", "package:lifecycle_hooks/app_component.template.dart",, V, {
    "^": "",
    ...
    ViewAppComponent0: {
      "^": "AppView;_app_component_template$_el_0,_app_component_template$_el_1,_app_component_template$_el_3,_app_component_template$_el_5,_app_component_template$_el_6,_app_component_template$_el_8,_app_component_template$_el_9,_app_component_template$_el_11,_el_12,_app_component_template$_el_14,_app_component_template$_el_15,_el_17,_app_component_template$_el_18,_el_20,_el_21,_el_23,_el_24,_el_25,_compView_25,_LoggerService_25_4,_PeekABooParentComponent_25_5,_el_26,_el_28,_el_29,_compView_29,_LoggerService_29_4,_SpyParentComponent_29_5,_el_30,_el_32,_el_33,_compView_33,_OnChangesParentComponent_33_4,_el_34,_el_36,_el_37,_compView_37,_DoCheckParentComponent_37_4,_el_38,_el_40,_el_41,_compView_41,_LoggerService_41_4,_AfterViewParentComponent_41_5,_el_42,_el_44,_el_45,_compView_45,_LoggerService_45_4,_AfterContentParentComponent_45_5,_el_46,_el_48,_el_49,_compView_49,_LoggerService_49_4,_CounterParentComponent_49_5,_el_50,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var parentRenderNode, doc, t1, _text_4, _text_7, _text_10, _text_13, _text_16, _text_19, _text_22, t2, _text_27, _text_31, _text_35, _text_39, _text_43, _text_47, _text_51;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_0 = t1;
        J.setAttribute$2$x(t1, "id", "top");
        t1 = S.createAndAppend(doc, "h1", parentRenderNode);
        this._app_component_template$_el_1 = t1;
        t1.appendChild(doc.createTextNode("Component Lifecycle Hooks"));
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_3 = t1;
        J.setAttribute$2$x(t1, "href", "#hooks");
        _text_4 = doc.createTextNode("Peek-a-boo: (most) lifecycle hooks");
        this._app_component_template$_el_3.appendChild(_text_4);
        this._app_component_template$_el_5 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_6 = t1;
        J.setAttribute$2$x(t1, "href", "#onchanges");
        _text_7 = doc.createTextNode("OnChanges");
        this._app_component_template$_el_6.appendChild(_text_7);
        this._app_component_template$_el_8 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_9 = t1;
        J.setAttribute$2$x(t1, "href", "#docheck");
        _text_10 = doc.createTextNode("DoCheck");
        this._app_component_template$_el_9.appendChild(_text_10);
        this._app_component_template$_el_11 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_12 = t1;
        J.setAttribute$2$x(t1, "href", "#after-view");
        _text_13 = doc.createTextNode("AfterViewInit & AfterViewChecked");
        this._el_12.appendChild(_text_13);
        this._app_component_template$_el_14 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_15 = t1;
        J.setAttribute$2$x(t1, "href", "#after-content");
        _text_16 = doc.createTextNode("AfterContentInit & AfterContentChecked");
        this._app_component_template$_el_15.appendChild(_text_16);
        this._el_17 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._app_component_template$_el_18 = t1;
        J.setAttribute$2$x(t1, "href", "#spy");
        _text_19 = doc.createTextNode("Spy: directive with OnInit & OnDestroy");
        this._app_component_template$_el_18.appendChild(_text_19);
        this._el_20 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_21 = t1;
        J.setAttribute$2$x(t1, "href", "#counter");
        _text_22 = doc.createTextNode("Counter: OnChanges + Spy directive");
        this._el_21.appendChild(_text_22);
        this._el_23 = S.createAndAppend(doc, "br", parentRenderNode);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_24 = t1;
        J.setAttribute$2$x(t1, "id", "hooks");
        t1 = A.ViewPeekABooParentComponent0$(this, 25);
        this._compView_25 = t1;
        t1 = t1.rootEl;
        this._el_25 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new D.LoggerService([], "", 1);
        this._LoggerService_25_4 = t1;
        t1 = new V.PeekABooParentComponent(t1, false, "Windstorm");
        this._PeekABooParentComponent_25_5 = t1;
        t2 = this._compView_25;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_26 = t2;
        J.setAttribute$2$x(t2, "href", "#top");
        _text_27 = doc.createTextNode("back to top");
        this._el_26.appendChild(_text_27);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_28 = t2;
        J.setAttribute$2$x(t2, "id", "spy");
        t2 = S.ViewSpyParentComponent0$(this, 29);
        this._compView_29 = t2;
        t2 = t2.rootEl;
        this._el_29 = t2;
        parentRenderNode.appendChild(t2);
        t2 = new D.LoggerService([], "", 1);
        this._LoggerService_29_4 = t2;
        t2 = new X.SpyParentComponent(t2, "Herbie", ["Windstorm", "Magneta"]);
        this._SpyParentComponent_29_5 = t2;
        t1 = this._compView_29;
        t1.ctx = t2;
        t1.viewData.projectableNodes = [];
        t1.build$0();
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_30 = t1;
        J.setAttribute$2$x(t1, "href", "#top");
        _text_31 = doc.createTextNode("back to top");
        this._el_30.appendChild(_text_31);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_32 = t1;
        J.setAttribute$2$x(t1, "id", "onchanges");
        t1 = S.ViewOnChangesParentComponent0$(this, 33);
        this._compView_33 = t1;
        t1 = t1.rootEl;
        this._el_33 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new D.OnChangesParentComponent(null, null, "OnChanges", null);
        t1.reset$0(0);
        this._OnChangesParentComponent_33_4 = t1;
        t2 = this._compView_33;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_34 = t2;
        J.setAttribute$2$x(t2, "href", "#top");
        _text_35 = doc.createTextNode("back to top");
        this._el_34.appendChild(_text_35);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_36 = t2;
        J.setAttribute$2$x(t2, "id", "docheck");
        t2 = M.ViewDoCheckParentComponent0$(this, 37);
        this._compView_37 = t2;
        t2 = t2.rootEl;
        this._el_37 = t2;
        parentRenderNode.appendChild(t2);
        t2 = new Q.DoCheckParentComponent(null, null, "DoCheck", null);
        t2.reset$0(0);
        this._DoCheckParentComponent_37_4 = t2;
        t1 = this._compView_37;
        t1.ctx = t2;
        t1.viewData.projectableNodes = [];
        t1.build$0();
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_38 = t1;
        J.setAttribute$2$x(t1, "href", "#top");
        _text_39 = doc.createTextNode("back to top");
        this._el_38.appendChild(_text_39);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_40 = t1;
        J.setAttribute$2$x(t1, "id", "after-view");
        t1 = S.ViewAfterViewParentComponent0$(this, 41);
        this._compView_41 = t1;
        t1 = t1.rootEl;
        this._el_41 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new D.LoggerService([], "", 1);
        this._LoggerService_41_4 = t1;
        t1 = new K.AfterViewParentComponent(t1, true);
        this._AfterViewParentComponent_41_5 = t1;
        t2 = this._compView_41;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_42 = t2;
        J.setAttribute$2$x(t2, "href", "#top");
        _text_43 = doc.createTextNode("back to top");
        this._el_42.appendChild(_text_43);
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_44 = t2;
        J.setAttribute$2$x(t2, "id", "after-content");
        t2 = V.ViewAfterContentParentComponent0$(this, 45);
        this._compView_45 = t2;
        t2 = t2.rootEl;
        this._el_45 = t2;
        parentRenderNode.appendChild(t2);
        t2 = new D.LoggerService([], "", 1);
        this._LoggerService_45_4 = t2;
        t2 = new Z.AfterContentParentComponent(t2, true);
        this._AfterContentParentComponent_45_5 = t2;
        t1 = this._compView_45;
        t1.ctx = t2;
        t1.viewData.projectableNodes = [];
        t1.build$0();
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_46 = t1;
        J.setAttribute$2$x(t1, "href", "#top");
        _text_47 = doc.createTextNode("back to top");
        this._el_46.appendChild(_text_47);
        t1 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_48 = t1;
        J.setAttribute$2$x(t1, "id", "counter");
        t1 = F.ViewCounterParentComponent0$(this, 49);
        this._compView_49 = t1;
        t1 = t1.rootEl;
        this._el_49 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new D.LoggerService([], "", 1);
        this._LoggerService_49_4 = t1;
        t1 = new D.CounterParentComponent(t1, null);
        t1.reset$0(0);
        this._CounterParentComponent_49_5 = t1;
        t2 = this._compView_49;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = S.createAndAppend(doc, "a", parentRenderNode);
        this._el_50 = t2;
        J.setAttribute$2$x(t2, "href", "#top");
        _text_51 = doc.createTextNode("back to top");
        this._el_50.appendChild(_text_51);
        this.init$2(C.List_empty, null);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        var t1 = token === C.Type_LoggerService_4CA;
        if (t1 && 25 === nodeIndex)
          return this._LoggerService_25_4;
        if (token === C.Type_PeekABooParentComponent_PPf && 25 === nodeIndex)
          return this._PeekABooParentComponent_25_5;
        if (t1 && 29 === nodeIndex)
          return this._LoggerService_29_4;
        if (token === C.Type_SpyParentComponent_Rss && 29 === nodeIndex)
          return this._SpyParentComponent_29_5;
        if (token === C.Type_OnChangesParentComponent_mBr && 33 === nodeIndex)
          return this._OnChangesParentComponent_33_4;
        if (token === C.Type_DoCheckParentComponent_8FR && 37 === nodeIndex)
          return this._DoCheckParentComponent_37_4;
        if (t1 && 41 === nodeIndex)
          return this._LoggerService_41_4;
        if (token === C.Type_AfterViewParentComponent_zvB && 41 === nodeIndex)
          return this._AfterViewParentComponent_41_5;
        if (t1 && 45 === nodeIndex)
          return this._LoggerService_45_4;
        if (token === C.Type_AfterContentParentComponent_iDZ && 45 === nodeIndex)
          return this._AfterContentParentComponent_45_5;
        if (t1 && 49 === nodeIndex)
          return this._LoggerService_49_4;
        if (token === C.Type_CounterParentComponent_OvD && 49 === nodeIndex)
          return this._CounterParentComponent_49_5;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
      ...
      destroyInternal$0: function() {
        var t1 = this._compView_25;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_29;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_33;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_37;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_41;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_45;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._compView_49;
        if (!(t1 == null))
          t1.destroy$0();
      }
    },
    _ViewAppComponentHost0: {
      ...
      build$0: function() {
        var t1, t2, t3;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), this, null, null, null);
  ...
  }], ["", "package:lifecycle_hooks/src/after_content_component.dart",, Z, {
    "^": "",
    ChildComponent: {
      "^": "Object;hero@"
    },
    AfterContentComponent: {
      "^": "Object;_after_content_component$_prevHero,comment<,contentChild,_logger",
      ngAfterContentChecked$0: function() {
        var t1, t2;
        t1 = this._after_content_component$_prevHero;
        t2 = this.contentChild;
        if (J.$eq$(t1, t2 == null ? t2 : t2.get$hero()))
          this._logIt$1("AfterContentChecked (no change)");
        else {
          t1 = this.contentChild;
          this._after_content_component$_prevHero = t1 == null ? t1 : t1.get$hero();
          this._logIt$1("AfterContentChecked");
          this._after_content_component$_doSomething$0();
        }
      },
      _after_content_component$_doSomething$0: function() {
        this.comment = J.$gt$n(J.get$length$asx(this.contentChild.get$hero()), 10) ? "That's a long name" : "";
      },
      _logIt$1: function(method) {
        var child, t1, t2;
        child = this.contentChild;
        t1 = method + ": ";
        t2 = child == null ? child : child.get$hero();
        this._logger.log$1(t1 + H.S(t2 == null ? "no" : t2) + " child content");
      }
    },
    AfterContentParentComponent: {
      ...
      reset$0: [function(_) {
        var t1 = this._logger;
        C.JSArray_methods.set$length(t1.logs, 0);
        this.show = false;
        t1.tick$0().then$1(new Z.AfterContentParentComponent_reset_closure(this));
      }, "call$0", "get$reset", 0, 0, 2]
    },
    AfterContentParentComponent_reset_closure: {
      "^": "Closure:1;$this",
      call$1: [function(_) {
        this.$this.show = true;
      }, null, null, 2, 0, null, 4, "call"]
    }
  }], ["", "package:lifecycle_hooks/src/after_content_component.template.dart",, V, {
    "^": "",
    viewFactory_ChildComponentHost0: [function(parentView, parentIndex) {
      var t1 = new V._ViewChildComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "after_content_component_template__viewFactory_ChildComponentHost0$closure", 4, 0, 3],
    viewFactory_AfterContentComponent1: [function(parentView, parentIndex) {
      var t1 = new V._ViewAfterContentComponent1(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewAfterContentComponent0__renderType;
      return t1;
    }, "call$2", "after_content_component_template__viewFactory_AfterContentComponent1$closure", 4, 0, 75],
    viewFactory_AfterContentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new V._ViewAfterContentComponentHost0(null, null, new D.QueryList(true, C.List_empty, null, [null]), null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "after_content_component_template__viewFactory_AfterContentComponentHost0$closure", 4, 0, 3],
    viewFactory_AfterContentParentComponent1: [function(parentView, parentIndex) {
      var t1 = new V._ViewAfterContentParentComponent1(null, null, null, null, new D.QueryList(true, C.List_empty, null, [null]), null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewAfterContentParentComponent0__renderType;
      return t1;
    }, "call$2", "after_content_component_template__viewFactory_AfterContentParentComponent1$closure", 4, 0, 23],
    viewFactory_AfterContentParentComponent2: [function(parentView, parentIndex) {
      var t1 = new V._ViewAfterContentParentComponent2(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewAfterContentParentComponent0__renderType;
      return t1;
    }, "call$2", "after_content_component_template__viewFactory_AfterContentParentComponent2$closure", 4, 0, 23],
    viewFactory_AfterContentParentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new V._ViewAfterContentParentComponentHost0(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "after_content_component_template__viewFactory_AfterContentParentComponentHost0$closure", 4, 0, 3],
    initReflector2: function() {
      ...
      t1.$indexSet(0, C.Type_ChildComponent_kaS, C.ComponentFactory_MUB);
      t1.$indexSet(0, C.Type_AfterContentComponent_gc6, C.ComponentFactory_wuX);
      t1.$indexSet(0, C.Type_AfterContentParentComponent_iDZ, C.ComponentFactory_WRd);
    },
    ViewChildComponent0: {
      "^": "AppView;_el_0,_DefaultValueAccessor_0_4,_NgValueAccessor_0_5,_NgModel_0_6,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewChildComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("my-child");
        this.rootEl = t1;
        t1 = $.ViewChildComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewChildComponent0__renderType = t1;
        }
      ...
      build$0: function() {
        ...
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        t1 = S.createAndAppend(document, "input", parentRenderNode);
        this._el_0 = t1;
        t1 = new O.DefaultValueAccessor(t1, new O.closure0(), new O.closure1());
        this._DefaultValueAccessor_0_4 = t1;
        t1 = [t1];
        this._NgValueAccessor_0_5 = t1;
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._NgModel_0_6 = t2;
        J._addEventListener$3$x(this._el_0, "input", this.eventHandler1$1(this.get$_handle_input_0_1()), null);
        J._addEventListener$3$x(this._el_0, "blur", this.eventHandler0$1(this._DefaultValueAccessor_0_4.get$touchHandler()), null);
        t1 = this._NgModel_0_6._update;
        t1.toString;
        this.init$2(C.List_empty, [new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_0_0()))]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_DefaultValueAccessor_EOZ && 0 === nodeIndex)
          return this._DefaultValueAccessor_0_4;
        if (token === C.OpaqueToken_NgValueAccessor && 0 === nodeIndex)
          return this._NgValueAccessor_0_5;
        if ((token === C.Type_NgModel_qx4 || token === C.Type_NgControl_GNi) && 0 === nodeIndex)
      ...
      detectChangesInternal$0: function() {
        ...
        this._NgModel_0_6.set$model(_ctx.get$hero());
        this._NgModel_0_6.ngAfterChanges$0();
        if (t1 === 0) {
          t1 = this._NgModel_0_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
      },
      _handle_ngModelChange_0_0$1: [function($$event) {
        this.ctx.set$hero($$event);
      }, "call$1", "get$_handle_ngModelChange_0_0", 2, 0, 4],
      _handle_input_0_1$1: [function($$event) {
        var t1, t2;
        t1 = this._DefaultValueAccessor_0_4;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_input_0_1", 2, 0, 4],
      static: {
        ViewChildComponent0$: function(parentView, parentIndex) {
          var t1 = new V.ViewChildComponent0(null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewChildComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewChildComponentHost0: {
      "^": "AppView;_compView_0,_ChildComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = V.ViewChildComponent0$(this, 0);
        this._compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new Z.ChildComponent("Magneta");
        this._ChildComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._ChildComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_ChildComponent_kaS && 0 === nodeIndex)
          return this._ChildComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
    ...
    ViewAfterContentComponent0: {
      "^": "AppView;_el_0,_el_2,_appEl_4,_NgIf_4_7,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewAfterContentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("after-content");
        this.rootEl = t1;
        t1 = $.ViewAfterContentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewAfterContentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        this._el_0 = t1;
        t1.appendChild(doc.createTextNode("-- projected content begins --"));
        this.project$2(parentRenderNode, 0);
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_2 = t1;
        t1.appendChild(doc.createTextNode("-- projected content ends --"));
        ...
        this._appEl_4 = t1;
        this._NgIf_4_7 = new K.NgIf(new D.TemplateRef(t1, V.after_content_component_template__viewFactory_AfterContentComponent1$closure()), t1, false);
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx = this.ctx;
        this._NgIf_4_7.set$ngIf(_ctx.get$comment().length !== 0);
      ...
      static: {
        ViewAfterContentComponent0$: function(parentView, parentIndex) {
          var t1 = new V.ViewAfterContentComponent0(null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewAfterContentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewAfterContentComponent1: {
      "^": "AppView;_el_0,_text_1,_after_content_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1, t2;
        doc = document;
        t1 = doc.createElement("p");
        this._el_0 = t1;
        t1.className = "comment";
      ...
      detectChangesInternal$0: function() {
        var currVal_0 = this.ctx.get$comment();
        if (this._after_content_component_template$_expr_0 !== currVal_0) {
          this._text_1.textContent = currVal_0;
          this._after_content_component_template$_expr_0 = currVal_0;
        }
      }
    },
    _ViewAfterContentComponentHost0: {
      "^": "AppView;_compView_0,_AfterContentComponent_0_4,_query_ChildComponent_0_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = V.ViewAfterContentComponent0$(this, 0);
        this._compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new Z.AfterContentComponent("", "", null, this.injectorGet$2(C.Type_LoggerService_4CA, this.viewData.parentIndex));
        t1._logIt$1("AfterContent constructor");
        this._AfterContentComponent_0_4 = t1;
        t1 = this._query_ChildComponent_0_0;
        t1.reset$1(0, []);
        t2 = this._AfterContentComponent_0_4;
        t2.contentChild = J.get$isNotEmpty$asx(t1._results) ? J.get$first$ax(t1._results) : null;
        t1 = this._compView_0;
        t2 = this._AfterContentComponent_0_4;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        ...
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._AfterContentComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_AfterContentComponent_gc6 && 0 === nodeIndex)
          return this._AfterContentComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        if (this.viewData._cdState === 0) {
          var t1 = this._AfterContentComponent_0_4;
          t1._logIt$1("AfterContentInit");
          t1._after_content_component$_doSomething$0();
        }
        this._AfterContentComponent_0_4.ngAfterContentChecked$0();
        this._compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._compView_0;
    ...
    ViewAfterContentParentComponent0: {
      "^": "AppView;_el_0,_el_1,_appEl_3,_NgIf_3_7,_el_4,_el_6,_el_7,_appEl_9,_NgFor_9_7,_after_content_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewAfterContentParentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("after-content-parent");
        this.rootEl = t1;
        t1 = $.ViewAfterContentParentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_y5f);
          $.ViewAfterContentParentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_2, _anchor_3, t2, _text_5, _text_8, _anchor_9;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_0 = t1;
        J.set$className$x(t1, "parent");
        this.addShimC$1(this._el_0);
        t1 = S.createAndAppend(doc, "h2", this._el_0);
        this._el_1 = t1;
        this.addShimE$1(t1);
        _text_2 = doc.createTextNode("AfterContent");
        this._el_1.appendChild(_text_2);
        t1 = $.$get$ngAnchor();
        _anchor_3 = t1.cloneNode(false);
        this._el_0.appendChild(_anchor_3);
        t2 = new V.ViewContainer(3, 0, this, _anchor_3, null, null, null);
        this._appEl_3 = t2;
        this._NgIf_3_7 = new K.NgIf(new D.TemplateRef(t2, V.after_content_component_template__viewFactory_AfterContentParentComponent1$closure()), t2, false);
        t2 = S.createAndAppend(doc, "h4", this._el_0);
        this._el_4 = t2;
        this.addShimE$1(t2);
        _text_5 = doc.createTextNode("-- AfterContent Logs --");
        this._el_4.appendChild(_text_5);
        t2 = S.createAndAppend(doc, "p", this._el_0);
        this._el_6 = t2;
        this.addShimE$1(t2);
        t2 = S.createAndAppend(doc, "button", this._el_6);
        this._el_7 = t2;
        this.addShimC$1(t2);
        _text_8 = doc.createTextNode("Reset");
        this._el_7.appendChild(_text_8);
        _anchor_9 = t1.cloneNode(false);
        this._el_0.appendChild(_anchor_9);
        t1 = new V.ViewContainer(9, 0, this, _anchor_9, null, null, null);
        this._appEl_9 = t1;
        this._NgFor_9_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, V.after_content_component_template__viewFactory_AfterContentParentComponent2$closure()));
        J._addEventListener$3$x(this._el_7, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx, currVal_1;
        _ctx = this.ctx;
        this._NgIf_3_7.set$ngIf(J.get$show$x(_ctx));
        currVal_1 = _ctx.get$logs();
        if (this._after_content_component_template$_expr_1 !== currVal_1) {
          this._NgFor_9_7.set$ngForOf(currVal_1);
          this._after_content_component_template$_expr_1 = currVal_1;
        }
        this._NgFor_9_7.ngDoCheck$0();
      ...
      static: {
        ViewAfterContentParentComponent0$: function(parentView, parentIndex) {
          var t1 = new V.ViewAfterContentParentComponent0(null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewAfterContentParentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewAfterContentParentComponent1: {
      "^": "AppView;_el_0,_el_1,_compView_1,_AfterContentComponent_1_4,_query_ChildComponent_1_0,_el_2,_compView_2,_ChildComponent_2_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = document.createElement("div");
        this._el_0 = t1;
        this.addShimC$1(t1);
        t1 = V.ViewAfterContentComponent0$(this, 1);
        this._compView_1 = t1;
        t1 = t1.rootEl;
        this._el_1 = t1;
        ...
        t1 = this.parentView;
        t1 = new Z.AfterContentComponent("", "", null, t1.parentView.injectorGet$2(C.Type_LoggerService_4CA, t1.viewData.parentIndex));
        t1._logIt$1("AfterContent constructor");
        this._AfterContentComponent_1_4 = t1;
        t1 = V.ViewChildComponent0$(this, 2);
        this._compView_2 = t1;
        t1 = t1.rootEl;
        this._el_2 = t1;
        this.addShimC$1(t1);
        t1 = new Z.ChildComponent("Magneta");
        this._ChildComponent_2_4 = t1;
        t2 = this._compView_2;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = this._query_ChildComponent_1_0;
        t2.reset$1(0, [this._ChildComponent_2_4]);
        t1 = this._AfterContentComponent_1_4;
        t1.contentChild = J.get$isNotEmpty$asx(t2._results) ? J.get$first$ax(t2._results) : null;
        t1 = this._compView_1;
        t2 = this._AfterContentComponent_1_4;
        t3 = this._el_2;
        t1.ctx = t2;
        t1.viewData.projectableNodes = [[t3]];
        t1.build$0();
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_ChildComponent_kaS && 2 === nodeIndex)
          return this._ChildComponent_2_4;
        if (token === C.Type_AfterContentComponent_gc6 && 1 <= nodeIndex && nodeIndex <= 2)
          return this._AfterContentComponent_1_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        if (this.viewData._cdState === 0) {
          var t1 = this._AfterContentComponent_1_4;
          t1._logIt$1("AfterContentInit");
          t1._after_content_component$_doSomething$0();
        }
        this._AfterContentComponent_1_4.ngAfterContentChecked$0();
    ...
    _ViewAfterContentParentComponent2: {
      "^": "AppView;_el_0,_text_1,_after_content_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
      ...
      detectChangesInternal$0: function() {
        var currVal_0 = Q.interpolate0(this.locals.$index(0, "$implicit"));
        if (this._after_content_component_template$_expr_0 !== currVal_0) {
          this._text_1.textContent = currVal_0;
          this._after_content_component_template$_expr_0 = currVal_0;
        }
    ...
    _ViewAfterContentParentComponentHost0: {
      "^": "AppView;_compView_0,_LoggerService_0_4,_AfterContentParentComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = V.ViewAfterContentParentComponent0$(this, 0);
        this._compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new D.LoggerService([], "", 1);
        this._LoggerService_0_4 = t2;
        t2 = new Z.AfterContentParentComponent(t2, true);
        this._AfterContentParentComponent_0_5 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._AfterContentParentComponent_0_5);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_LoggerService_4CA && 0 === nodeIndex)
          return this._LoggerService_0_4;
        if (token === C.Type_AfterContentParentComponent_iDZ && 0 === nodeIndex)
          return this._AfterContentParentComponent_0_5;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._compView_0.detectChanges$0();
  ...
  }], ["", "package:lifecycle_hooks/src/after_view_component.dart",, K, {
    "^": "",
    ChildViewComponent: {
      "^": "Object;hero@"
    },
    AfterViewComponent: {
      "^": "Object;_prevHero,viewChild?,_after_view_component$_logger,comment<",
      ngAfterViewChecked$0: function() {
        if (J.$eq$(this._prevHero, this.viewChild.get$hero()))
          this._after_view_component$_logIt$1("AfterViewChecked (no change)");
        else {
          this._prevHero = this.viewChild.get$hero();
          this._after_view_component$_logIt$1("AfterViewChecked");
          this._doSomething$0();
        }
      },
      _doSomething$0: function() {
        var c = J.$gt$n(J.get$length$asx(this.viewChild.get$hero()), 10) ? "That's a long name" : "";
        if (c !== this.comment)
          this._after_view_component$_logger.tick$0().then$1(new K.AfterViewComponent__doSomething_closure(this, c));
      },
      _after_view_component$_logIt$1: function(method) {
        var child, t1;
        child = this.viewChild;
        t1 = method + ": ";
        this._after_view_component$_logger.log$1(t1 + H.S(child != null ? child.get$hero() : "no") + " child view");
      }
    },
    AfterViewComponent__doSomething_closure: {
      "^": "Closure:1;$this,c",
      call$1: [function(_) {
        this.$this.comment = this.c;
      }, null, null, 2, 0, null, 4, "call"]
    },
    AfterViewParentComponent: {
      "^": "Object;_after_view_component$_logger,show>",
      get$logs: function() {
        return this._after_view_component$_logger.logs;
      },
      reset$0: [function(_) {
        var t1 = this._after_view_component$_logger;
        C.JSArray_methods.set$length(t1.logs, 0);
        this.show = false;
        t1.tick$0().then$1(new K.AfterViewParentComponent_reset_closure(this));
      }, "call$0", "get$reset", 0, 0, 2]
    },
    AfterViewParentComponent_reset_closure: {
      "^": "Closure:1;$this",
      call$1: [function(_) {
        this.$this.show = true;
      }, null, null, 2, 0, null, 4, "call"]
    }
  }], ["", "package:lifecycle_hooks/src/after_view_component.template.dart",, S, {
    "^": "",
    viewFactory_ChildViewComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewChildViewComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "after_view_component_template__viewFactory_ChildViewComponentHost0$closure", 4, 0, 3],
    viewFactory_AfterViewComponent1: [function(parentView, parentIndex) {
      var t1 = new S._ViewAfterViewComponent1(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewAfterViewComponent0__renderType;
      return t1;
    }, "call$2", "after_view_component_template__viewFactory_AfterViewComponent1$closure", 4, 0, 77],
    viewFactory_AfterViewComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewAfterViewComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "after_view_component_template__viewFactory_AfterViewComponentHost0$closure", 4, 0, 3],
    viewFactory_AfterViewParentComponent1: [function(parentView, parentIndex) {
      var t1 = new S._ViewAfterViewParentComponent1(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewAfterViewParentComponent0__renderType;
      return t1;
    }, "call$2", "after_view_component_template__viewFactory_AfterViewParentComponent1$closure", 4, 0, 24],
    viewFactory_AfterViewParentComponent2: [function(parentView, parentIndex) {
      var t1 = new S._ViewAfterViewParentComponent2(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewAfterViewParentComponent0__renderType;
      return t1;
    }, "call$2", "after_view_component_template__viewFactory_AfterViewParentComponent2$closure", 4, 0, 24],
    viewFactory_AfterViewParentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewAfterViewParentComponentHost0(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "after_view_component_template__viewFactory_AfterViewParentComponentHost0$closure", 4, 0, 3],
    initReflector3: function() {
      ...
      K.initReflector10();
      var t1 = $.$get$_components();
      t1.$indexSet(0, C.Type_ChildViewComponent_ctK, C.ComponentFactory_cWU);
      t1.$indexSet(0, C.Type_AfterViewComponent_RTB, C.ComponentFactory_G5K);
      t1.$indexSet(0, C.Type_AfterViewParentComponent_zvB, C.ComponentFactory_GC3);
    },
    ViewChildViewComponent0: {
      "^": "AppView;_after_view_component_template$_el_0,_after_view_component_template$_DefaultValueAccessor_0_4,_after_view_component_template$_NgValueAccessor_0_5,_after_view_component_template$_NgModel_0_6,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewChildViewComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("my-child-view");
        this.rootEl = t1;
        t1 = $.ViewChildViewComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewChildViewComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        t1 = S.createAndAppend(document, "input", parentRenderNode);
        this._after_view_component_template$_el_0 = t1;
        t1 = new O.DefaultValueAccessor(t1, new O.closure0(), new O.closure1());
        this._after_view_component_template$_DefaultValueAccessor_0_4 = t1;
        t1 = [t1];
        this._after_view_component_template$_NgValueAccessor_0_5 = t1;
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._after_view_component_template$_NgModel_0_6 = t2;
        J._addEventListener$3$x(this._after_view_component_template$_el_0, "input", this.eventHandler1$1(this.get$_after_view_component_template$_handle_input_0_1()), null);
        J._addEventListener$3$x(this._after_view_component_template$_el_0, "blur", this.eventHandler0$1(this._after_view_component_template$_DefaultValueAccessor_0_4.get$touchHandler()), null);
        t1 = this._after_view_component_template$_NgModel_0_6._update;
        t1.toString;
        this.init$2(C.List_empty, [new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_after_view_component_template$_handle_ngModelChange_0_0()))]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_DefaultValueAccessor_EOZ && 0 === nodeIndex)
          return this._after_view_component_template$_DefaultValueAccessor_0_4;
        if (token === C.OpaqueToken_NgValueAccessor && 0 === nodeIndex)
          return this._after_view_component_template$_NgValueAccessor_0_5;
        if ((token === C.Type_NgModel_qx4 || token === C.Type_NgControl_GNi) && 0 === nodeIndex)
          return this._after_view_component_template$_NgModel_0_6;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, t1;
        _ctx = this.ctx;
        t1 = this.viewData._cdState;
        this._after_view_component_template$_NgModel_0_6.set$model(_ctx.get$hero());
        this._after_view_component_template$_NgModel_0_6.ngAfterChanges$0();
        if (t1 === 0) {
          t1 = this._after_view_component_template$_NgModel_0_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
      },
      _after_view_component_template$_handle_ngModelChange_0_0$1: [function($$event) {
        this.ctx.set$hero($$event);
      }, "call$1", "get$_after_view_component_template$_handle_ngModelChange_0_0", 2, 0, 4],
      _after_view_component_template$_handle_input_0_1$1: [function($$event) {
        var t1, t2;
        t1 = this._after_view_component_template$_DefaultValueAccessor_0_4;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_after_view_component_template$_handle_input_0_1", 2, 0, 4],
      static: {
        ViewChildViewComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewChildViewComponent0(null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewChildViewComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewChildViewComponentHost0: {
      "^": "AppView;_after_view_component_template$_compView_0,_ChildViewComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = S.ViewChildViewComponent0$(this, 0);
        this._after_view_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new K.ChildViewComponent("Magneta");
        this._ChildViewComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._ChildViewComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_ChildViewComponent_ctK && 0 === nodeIndex)
          return this._ChildViewComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._after_view_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._after_view_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    },
    ViewAfterViewComponent0: {
      "^": "AppView;_viewQuery_ChildViewComponent_0,_after_view_component_template$_el_0,_after_view_component_template$_el_2,_after_view_component_template$_compView_2,_ChildViewComponent_2_4,_el_3,_appEl_5,_NgIf_5_7,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewAfterViewComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("after-view");
        this.rootEl = t1;
        t1 = $.ViewAfterViewComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_1, C.List_empty);
          $.ViewAfterViewComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, t2, _anchor_5;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._after_view_component_template$_el_0 = t1;
        t1.appendChild(doc.createTextNode("-- child view begins --"));
        t1 = S.ViewChildViewComponent0$(this, 2);
        this._after_view_component_template$_compView_2 = t1;
        t1 = t1.rootEl;
        this._after_view_component_template$_el_2 = t1;
        parentRenderNode.appendChild(t1);
        t1 = new K.ChildViewComponent("Magneta");
        this._ChildViewComponent_2_4 = t1;
        t2 = this._after_view_component_template$_compView_2;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_3 = t2;
        t2.appendChild(doc.createTextNode("-- child view ends --"));
        _anchor_5 = $.$get$ngAnchor().cloneNode(false);
        parentRenderNode.appendChild(_anchor_5);
        t2 = new V.ViewContainer(5, null, this, _anchor_5, null, null, null);
        this._appEl_5 = t2;
        this._NgIf_5_7 = new K.NgIf(new D.TemplateRef(t2, S.after_view_component_template__viewFactory_AfterViewComponent1$closure()), t2, false);
        t2 = this._viewQuery_ChildViewComponent_0;
        t2.reset$1(0, [this._ChildViewComponent_2_4]);
        t1 = this.ctx;
        t1.set$viewChild(J.get$isNotEmpty$asx(t2._results) ? J.get$first$ax(t2._results) : null);
        this.init$2(C.List_empty, null);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_ChildViewComponent_ctK && 2 === nodeIndex)
          return this._ChildViewComponent_2_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx = this.ctx;
        this._NgIf_5_7.set$ngIf(_ctx.get$comment().length !== 0);
        this._appEl_5.detectChangesInNestedViews$0();
        this._after_view_component_template$_compView_2.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._appEl_5;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
        t1 = this._after_view_component_template$_compView_2;
        if (!(t1 == null))
          t1.destroy$0();
      },
      static: {
        ViewAfterViewComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewAfterViewComponent0(new D.QueryList(true, C.List_empty, null, [null]), null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewAfterViewComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewAfterViewComponent1: {
      "^": "AppView;_after_view_component_template$_el_0,_after_view_component_template$_text_1,_after_view_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1, t2;
        doc = document;
        t1 = doc.createElement("p");
        ...
        t1.className = "comment";
        t2 = doc.createTextNode("");
        this._after_view_component_template$_text_1 = t2;
        t1.appendChild(t2);
        this.init0$1(this._after_view_component_template$_el_0);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0 = this.ctx.get$comment();
        if (this._after_view_component_template$_expr_0 !== currVal_0) {
          this._after_view_component_template$_text_1.textContent = currVal_0;
          this._after_view_component_template$_expr_0 = currVal_0;
        }
      }
    },
    _ViewAfterViewComponentHost0: {
      "^": "AppView;_after_view_component_template$_compView_0,_AfterViewComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = S.ViewAfterViewComponent0$(this, 0);
        this._after_view_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new K.AfterViewComponent("", null, this.injectorGet$2(C.Type_LoggerService_4CA, this.viewData.parentIndex), "");
        t1._after_view_component$_logIt$1("AfterView constructor");
        this._AfterViewComponent_0_4 = t1;
        t2 = this._after_view_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._AfterViewComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_AfterViewComponent_RTB && 0 === nodeIndex)
          return this._AfterViewComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        ...
        this._after_view_component_template$_compView_0.detectChanges$0();
        if (t1 === 0) {
          t1 = this._AfterViewComponent_0_4;
          t1._after_view_component$_logIt$1("AfterViewInit");
          t1._doSomething$0();
        }
        this._AfterViewComponent_0_4.ngAfterViewChecked$0();
      },
      destroyInternal$0: function() {
        var t1 = this._after_view_component_template$_compView_0;
        if (!(t1 == null))
    ...
    ViewAfterViewParentComponent0: {
      "^": "AppView;_after_view_component_template$_el_0,_after_view_component_template$_el_1,_after_view_component_template$_appEl_3,_after_view_component_template$_NgIf_3_7,_after_view_component_template$_el_4,_after_view_component_template$_el_6,_after_view_component_template$_el_7,_after_view_component_template$_appEl_9,_after_view_component_template$_NgFor_9_7,_after_view_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewAfterViewParentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("after-view-parent");
        this.rootEl = t1;
        t1 = $.ViewAfterViewParentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_y5f);
          $.ViewAfterViewParentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        this._after_view_component_template$_el_0 = t1;
        J.set$className$x(t1, "parent");
        this.addShimC$1(this._after_view_component_template$_el_0);
        t1 = S.createAndAppend(doc, "h2", this._after_view_component_template$_el_0);
        this._after_view_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        _text_2 = doc.createTextNode("AfterView");
        this._after_view_component_template$_el_1.appendChild(_text_2);
        t1 = $.$get$ngAnchor();
        _anchor_3 = t1.cloneNode(false);
        this._after_view_component_template$_el_0.appendChild(_anchor_3);
        t2 = new V.ViewContainer(3, 0, this, _anchor_3, null, null, null);
        this._after_view_component_template$_appEl_3 = t2;
        this._after_view_component_template$_NgIf_3_7 = new K.NgIf(new D.TemplateRef(t2, S.after_view_component_template__viewFactory_AfterViewParentComponent1$closure()), t2, false);
        t2 = S.createAndAppend(doc, "h4", this._after_view_component_template$_el_0);
        this._after_view_component_template$_el_4 = t2;
        this.addShimE$1(t2);
        _text_5 = doc.createTextNode("-- AfterView Logs --");
        this._after_view_component_template$_el_4.appendChild(_text_5);
        t2 = S.createAndAppend(doc, "p", this._after_view_component_template$_el_0);
        this._after_view_component_template$_el_6 = t2;
        this.addShimE$1(t2);
        t2 = S.createAndAppend(doc, "button", this._after_view_component_template$_el_6);
        this._after_view_component_template$_el_7 = t2;
        this.addShimC$1(t2);
        _text_8 = doc.createTextNode("Reset");
        this._after_view_component_template$_el_7.appendChild(_text_8);
        _anchor_9 = t1.cloneNode(false);
        this._after_view_component_template$_el_0.appendChild(_anchor_9);
        t1 = new V.ViewContainer(9, 0, this, _anchor_9, null, null, null);
        this._after_view_component_template$_appEl_9 = t1;
        this._after_view_component_template$_NgFor_9_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, S.after_view_component_template__viewFactory_AfterViewParentComponent2$closure()));
        J._addEventListener$3$x(this._after_view_component_template$_el_7, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx, currVal_1;
        _ctx = this.ctx;
        this._after_view_component_template$_NgIf_3_7.set$ngIf(J.get$show$x(_ctx));
        currVal_1 = _ctx.get$logs();
        if (this._after_view_component_template$_expr_1 !== currVal_1) {
          this._after_view_component_template$_NgFor_9_7.set$ngForOf(currVal_1);
          this._after_view_component_template$_expr_1 = currVal_1;
        }
        this._after_view_component_template$_NgFor_9_7.ngDoCheck$0();
        this._after_view_component_template$_appEl_3.detectChangesInNestedViews$0();
        this._after_view_component_template$_appEl_9.detectChangesInNestedViews$0();
      },
      destroyInternal$0: function() {
        var t1 = this._after_view_component_template$_appEl_3;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
        t1 = this._after_view_component_template$_appEl_9;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
      },
      static: {
        ViewAfterViewParentComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewAfterViewParentComponent0(null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewAfterViewParentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewAfterViewParentComponent1: {
      "^": "AppView;_after_view_component_template$_el_0,_after_view_component_template$_compView_0,_AfterViewComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2;
        t1 = S.ViewAfterViewComponent0$(this, 0);
        this._after_view_component_template$_compView_0 = t1;
        ...
        this.addShimC$1(t1);
        t1 = this.parentView;
        t1 = new K.AfterViewComponent("", null, t1.parentView.injectorGet$2(C.Type_LoggerService_4CA, t1.viewData.parentIndex), "");
        t1._after_view_component$_logIt$1("AfterView constructor");
        this._AfterViewComponent_0_4 = t1;
        t2 = this._after_view_component_template$_compView_0;
        t2.ctx = t1;
    ...
    _ViewAfterViewParentComponent2: {
      "^": "AppView;_after_view_component_template$_el_0,_after_view_component_template$_text_1,_after_view_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        ...
        this.addShimC$1(t1);
        t1 = doc.createTextNode("");
        this._after_view_component_template$_text_1 = t1;
        this._after_view_component_template$_el_0.appendChild(t1);
        this.init0$1(this._after_view_component_template$_el_0);
        return;
      },
      detectChangesInternal$0: function() {
    ...
    _ViewAfterViewParentComponentHost0: {
      "^": "AppView;_after_view_component_template$_compView_0,_after_view_component_template$_LoggerService_0_4,_AfterViewParentComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = S.ViewAfterViewParentComponent0$(this, 0);
        this._after_view_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new D.LoggerService([], "", 1);
        this._after_view_component_template$_LoggerService_0_4 = t2;
        t2 = new K.AfterViewParentComponent(t2, true);
        this._AfterViewParentComponent_0_5 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._AfterViewParentComponent_0_5);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_LoggerService_4CA && 0 === nodeIndex)
          return this._after_view_component_template$_LoggerService_0_4;
        if (token === C.Type_AfterViewParentComponent_zvB && 0 === nodeIndex)
          return this._AfterViewParentComponent_0_5;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._after_view_component_template$_compView_0.detectChanges$0();
  ...
  }], ["", "package:lifecycle_hooks/src/counter_component.dart",, D, {
    "^": "",
    MyCounterComponent: {
      "^": "Object;counter<,changeLog<"
    },
    CounterParentComponent: {
      "^": "Object;_counter_component$_logger,value>",
      get$logs: function() {
        return this._counter_component$_logger.logs;
      },
      updateCounter$0: [function() {
        var t1 = this.value;
        if (typeof t1 !== "number")
          return t1.$add();
        this.value = t1 + 1;
        this._counter_component$_logger.tick$0();
      }, "call$0", "get$updateCounter", 0, 0, 2],
      reset$0: [function(_) {
        var t1 = this._counter_component$_logger;
        t1.log$1("-- reset --");
        this.value = 0;
        t1.tick$0();
      }, "call$0", "get$reset", 0, 0, 2]
    }
  }], ["", "package:lifecycle_hooks/src/counter_component.template.dart",, F, {
    "^": "",
    viewFactory_MyCounterComponent1: [function(parentView, parentIndex) {
      var t1 = new F._ViewMyCounterComponent1(null, null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewMyCounterComponent0__renderType;
      return t1;
    }, "call$2", "counter_component_template__viewFactory_MyCounterComponent1$closure", 4, 0, 79],
    viewFactory_MyCounterComponentHost0: [function(parentView, parentIndex) {
      var t1 = new F._ViewMyCounterComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "counter_component_template__viewFactory_MyCounterComponentHost0$closure", 4, 0, 3],
    viewFactory_CounterParentComponent1: [function(parentView, parentIndex) {
      var t1 = new F._ViewCounterParentComponent1(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewCounterParentComponent0__renderType;
      return t1;
    }, "call$2", "counter_component_template__viewFactory_CounterParentComponent1$closure", 4, 0, 80],
    viewFactory_CounterParentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new F._ViewCounterParentComponentHost0(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "counter_component_template__viewFactory_CounterParentComponentHost0$closure", 4, 0, 3],
    initReflector4: function() {
      ...
      F.initReflector11();
      var t1 = $.$get$_components();
      t1.$indexSet(0, C.Type_MyCounterComponent_f7L, C.ComponentFactory_qJr);
      t1.$indexSet(0, C.Type_CounterParentComponent_OvD, C.ComponentFactory_lRY);
    },
    ViewMyCounterComponent0: {
      "^": "AppView;_counter_component_template$_el_0,_counter_component_template$_text_1,_counter_component_template$_el_2,_counter_component_template$_appEl_4,_NgFor_4_7,_counter_component_template$_expr_0,_counter_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewMyCounterComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("my-counter");
        this.rootEl = t1;
        t1 = $.ViewMyCounterComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_EGJ);
          $.ViewMyCounterComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_3, _anchor_4;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._counter_component_template$_el_0 = t1;
        J.set$className$x(t1, "counter");
        this.addShimC$1(this._counter_component_template$_el_0);
        t1 = doc.createTextNode("");
        this._counter_component_template$_text_1 = t1;
        this._counter_component_template$_el_0.appendChild(t1);
        t1 = S.createAndAppend(doc, "h5", this._counter_component_template$_el_0);
        this._counter_component_template$_el_2 = t1;
        this.addShimE$1(t1);
        _text_3 = doc.createTextNode("-- Counter Change Log --");
        this._counter_component_template$_el_2.appendChild(_text_3);
        _anchor_4 = $.$get$ngAnchor().cloneNode(false);
        this._counter_component_template$_el_0.appendChild(_anchor_4);
        t1 = new V.ViewContainer(4, 0, this, _anchor_4, null, null, null);
        this._counter_component_template$_appEl_4 = t1;
        this._NgFor_4_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, F.counter_component_template__viewFactory_MyCounterComponent1$closure()));
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx, currVal_1, t1, currVal_0;
        _ctx = this.ctx;
        currVal_1 = _ctx.get$changeLog();
        if (this._counter_component_template$_expr_1 !== currVal_1) {
          this._NgFor_4_7.set$ngForOf(currVal_1);
          this._counter_component_template$_expr_1 = currVal_1;
        }
        this._NgFor_4_7.ngDoCheck$0();
        this._counter_component_template$_appEl_4.detectChangesInNestedViews$0();
        t1 = _ctx.get$counter();
        currVal_0 = "Counter=" + (t1 == null ? "" : H.S(t1));
        if (this._counter_component_template$_expr_0 !== currVal_0) {
          this._counter_component_template$_text_1.textContent = currVal_0;
          this._counter_component_template$_expr_0 = currVal_0;
        }
      },
      destroyInternal$0: function() {
        var t1 = this._counter_component_template$_appEl_4;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
      },
      static: {
        ViewMyCounterComponent0$: function(parentView, parentIndex) {
          var t1 = new F.ViewMyCounterComponent0(null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewMyCounterComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewMyCounterComponent1: {
      "^": "AppView;_counter_component_template$_el_0,_SpyDirective_0_4,_counter_component_template$_text_1,_counter_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        t1 = doc.createElement("div");
        this._counter_component_template$_el_0 = t1;
        t1.setAttribute("mySpy", "");
        this.addShimC$1(this._counter_component_template$_el_0);
        t1 = this.parentView;
        this._SpyDirective_0_4 = new F.SpyDirective(t1.parentView.injectorGet$2(C.Type_LoggerService_4CA, t1.viewData.parentIndex));
        t1 = doc.createTextNode("");
        this._counter_component_template$_text_1 = t1;
        this._counter_component_template$_el_0.appendChild(t1);
        this.init0$1(this._counter_component_template$_el_0);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        var t1;
        if (token === C.Type_SpyDirective_w2Y)
          t1 = nodeIndex <= 1;
        else
          t1 = false;
        if (t1)
          return this._SpyDirective_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var t1, local_chg, t2, currVal_0;
        t1 = this.viewData._cdState;
        local_chg = this.locals.$index(0, "$implicit");
        if (t1 === 0) {
          t1 = this._SpyDirective_0_4._spy_directive$_logger;
          t2 = $._nextId0;
          $._nextId0 = t2 + 1;
          t1.log$1("Spy #" + t2 + " onInit");
        }
        currVal_0 = Q.interpolate0(local_chg);
        if (this._counter_component_template$_expr_0 !== currVal_0) {
          this._counter_component_template$_text_1.textContent = currVal_0;
          this._counter_component_template$_expr_0 = currVal_0;
        }
      ...
      destroyInternal$0: function() {
        ...
        t2 = $._nextId0;
        $._nextId0 = t2 + 1;
        t1.log$1("Spy #" + t2 + " onDestroy");
      }
    },
    _ViewMyCounterComponentHost0: {
      "^": "AppView;_counter_component_template$_compView_0,_MyCounterComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = F.ViewMyCounterComponent0$(this, 0);
        this._counter_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new D.MyCounterComponent(null, []);
        this._MyCounterComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._MyCounterComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_MyCounterComponent_f7L && 0 === nodeIndex)
          return this._MyCounterComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._counter_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._counter_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    },
    ViewCounterParentComponent0: {
      "^": "AppView;_counter_component_template$_el_0,_counter_component_template$_el_1,_counter_component_template$_el_3,_el_5,_counter_component_template$_el_7,_compView_7,_MyCounterComponent_7_4,_el_8,_appEl_10,_NgFor_10_7,_counter_component_template$_expr_0,_counter_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewCounterParentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("counter-parent");
        this.rootEl = t1;
        t1 = $.ViewCounterParentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_0Zn);
          $.ViewCounterParentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_2, _text_4, _text_6, t2, _text_9, _anchor_10;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._counter_component_template$_el_0 = t1;
        J.set$className$x(t1, "parent");
        this.addShimC$1(this._counter_component_template$_el_0);
        t1 = S.createAndAppend(doc, "h2", this._counter_component_template$_el_0);
        this._counter_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        _text_2 = doc.createTextNode("Counter Spy");
        this._counter_component_template$_el_1.appendChild(_text_2);
        t1 = S.createAndAppend(doc, "button", this._counter_component_template$_el_0);
        this._counter_component_template$_el_3 = t1;
        this.addShimC$1(t1);
        _text_4 = doc.createTextNode("Update counter");
        this._counter_component_template$_el_3.appendChild(_text_4);
        t1 = S.createAndAppend(doc, "button", this._counter_component_template$_el_0);
        this._el_5 = t1;
        this.addShimC$1(t1);
        _text_6 = doc.createTextNode("Reset Counter");
        this._el_5.appendChild(_text_6);
        t1 = F.ViewMyCounterComponent0$(this, 7);
        this._compView_7 = t1;
        t1 = t1.rootEl;
        this._counter_component_template$_el_7 = t1;
        this._counter_component_template$_el_0.appendChild(t1);
        this.addShimC$1(this._counter_component_template$_el_7);
        t1 = new D.MyCounterComponent(null, []);
        this._MyCounterComponent_7_4 = t1;
        t2 = this._compView_7;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        t2 = S.createAndAppend(doc, "h4", this._counter_component_template$_el_0);
        this._el_8 = t2;
        this.addShimE$1(t2);
        _text_9 = doc.createTextNode("-- Spy Lifecycle Hook Log --");
        this._el_8.appendChild(_text_9);
        _anchor_10 = $.$get$ngAnchor().cloneNode(false);
        this._counter_component_template$_el_0.appendChild(_anchor_10);
        t2 = new V.ViewContainer(10, 0, this, _anchor_10, null, null, null);
        this._appEl_10 = t2;
        this._NgFor_10_7 = new R.NgFor(t2, null, null, null, new D.TemplateRef(t2, F.counter_component_template__viewFactory_CounterParentComponent1$closure()));
        J._addEventListener$3$x(this._counter_component_template$_el_3, "click", this.eventHandler0$1(this.ctx.get$updateCounter()), null);
        J._addEventListener$3$x(this._el_5, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        this.init$2(C.List_empty, null);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_MyCounterComponent_f7L && 7 === nodeIndex)
          return this._MyCounterComponent_7_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, currVal_0, t1, changes, chng, cur, prev, currVal_1;
        _ctx = this.ctx;
        currVal_0 = J.get$value$x(_ctx);
        t1 = this._counter_component_template$_expr_0;
        if (t1 == null ? currVal_0 != null : t1 !== currVal_0) {
          this._MyCounterComponent_7_4.counter = currVal_0;
          changes = P.LinkedHashMap_LinkedHashMap$_empty(P.String, A.SimpleChange);
          changes.$indexSet(0, "counter", new A.SimpleChange(t1, currVal_0));
          this._counter_component_template$_expr_0 = currVal_0;
        } else
          changes = null;
        if (changes != null) {
          t1 = this._MyCounterComponent_7_4;
          if (J.$eq$(t1.counter, 0))
            C.JSArray_methods.set$length(t1.changeLog, 0);
          chng = changes.$index(0, "counter");
          cur = chng.get$currentValue();
          prev = chng.get$previousValue() == null ? "{}" : chng.get$previousValue();
          t1.changeLog.push("counter: currentValue = " + H.S(cur) + ", previousValue = " + H.S(prev));
        }
        currVal_1 = _ctx.get$logs();
        if (this._counter_component_template$_expr_1 !== currVal_1) {
          this._NgFor_10_7.set$ngForOf(currVal_1);
          this._counter_component_template$_expr_1 = currVal_1;
        }
        this._NgFor_10_7.ngDoCheck$0();
        this._appEl_10.detectChangesInNestedViews$0();
        this._compView_7.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._appEl_10;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
        t1 = this._compView_7;
        if (!(t1 == null))
      ...
      static: {
        ViewCounterParentComponent0$: function(parentView, parentIndex) {
          var t1 = new F.ViewCounterParentComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewCounterParentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewCounterParentComponent1: {
      "^": "AppView;_counter_component_template$_el_0,_counter_component_template$_text_1,_counter_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        t1 = doc.createElement("div");
    ...
    _ViewCounterParentComponentHost0: {
      "^": "AppView;_counter_component_template$_compView_0,_counter_component_template$_LoggerService_0_4,_CounterParentComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = F.ViewCounterParentComponent0$(this, 0);
        this._counter_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new D.LoggerService([], "", 1);
        this._counter_component_template$_LoggerService_0_4 = t1;
        t1 = new D.CounterParentComponent(t1, null);
        t1.reset$0(0);
        this._CounterParentComponent_0_5 = t1;
        t2 = this._counter_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._CounterParentComponent_0_5);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_LoggerService_4CA && 0 === nodeIndex)
          return this._counter_component_template$_LoggerService_0_4;
        if (token === C.Type_CounterParentComponent_OvD && 0 === nodeIndex)
          return this._CounterParentComponent_0_5;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._counter_component_template$_compView_0.detectChanges$0();
  ...
  }], ["", "package:lifecycle_hooks/src/do_check_component.dart",, Q, {
    "^": "",
    Hero: {
      "^": "Object;name*",
      toJson$0: function() {
    ...
    DoCheckComponent: {
      "^": "Object;hero@,power@,changeDetected,changeLog<,oldHeroName,oldPower,oldLogLength,noChangeCount",
      ngDoCheck$0: function() {
        var t1, noChangeMsg, t2, t3;
        if (!J.$eq$(J.get$name$x(this.hero), this.oldHeroName)) {
          this.changeDetected = true;
          this.changeLog.push('DoCheck: Hero name changed to "' + H.S(J.get$name$x(this.hero)) + '" from "' + H.S(this.oldHeroName) + '"');
          this.oldHeroName = J.get$name$x(this.hero);
        }
        if (!J.$eq$(this.power, this.oldPower)) {
          this.changeDetected = true;
          this.changeLog.push('DoCheck: Power changed to "' + H.S(this.power) + '" from "' + H.S(this.oldPower) + '"');
          this.oldPower = this.power;
        }
        if (this.changeDetected)
          this.noChangeCount = 0;
        else {
          t1 = ++this.noChangeCount;
          noChangeMsg = "DoCheck called " + t1 + "x when no change to hero or power";
          t2 = this.changeLog;
          if (t1 === 1)
            t2.push(noChangeMsg);
          else {
      ...
      reset$0: [function(_) {
        this.changeDetected = true;
        C.JSArray_methods.set$length(this.changeLog, 0);
      }, "call$0", "get$reset", 0, 0, 2]
    },
    DoCheckParentComponent: {
      "^": "Object;hero@,power@,title>,childView?",
      reset$0: [function(_) {
        var t1;
        this.hero = new Q.Hero("Windstorm");
        this.power = "sing";
        t1 = this.childView;
        if (!(t1 == null))
          J.reset$0$x(t1);
  ...
  }], ["", "package:lifecycle_hooks/src/do_check_component.template.dart",, M, {
    "^": "",
    viewFactory_DoCheckComponent1: [function(parentView, parentIndex) {
      var t1 = new M._ViewDoCheckComponent1(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewDoCheckComponent0__renderType;
      return t1;
    }, "call$2", "do_check_component_template__viewFactory_DoCheckComponent1$closure", 4, 0, 81],
    viewFactory_DoCheckComponentHost0: [function(parentView, parentIndex) {
      var t1 = new M._ViewDoCheckComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "do_check_component_template__viewFactory_DoCheckComponentHost0$closure", 4, 0, 3],
    viewFactory_DoCheckParentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new M._ViewDoCheckParentComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "do_check_component_template__viewFactory_DoCheckParentComponentHost0$closure", 4, 0, 3],
    initReflector5: function() {
      ...
      K.initReflector10();
      var t1 = $.$get$_components();
      t1.$indexSet(0, C.Type_DoCheckComponent_IGs, C.ComponentFactory_2No);
      t1.$indexSet(0, C.Type_DoCheckParentComponent_8FR, C.ComponentFactory_hk6);
    },
    ViewDoCheckComponent0: {
      "^": "AppView;_do_check_component_template$_el_0,_do_check_component_template$_el_1,_text_2,_do_check_component_template$_el_3,_do_check_component_template$_appEl_5,_NgFor_5_7,_do_check_component_template$_expr_0,_do_check_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewDoCheckComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("do-check");
        this.rootEl = t1;
        t1 = $.ViewDoCheckComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_PPN);
          $.ViewDoCheckComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_4, _anchor_5;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._do_check_component_template$_el_0 = t1;
        J.set$className$x(t1, "hero");
        this.addShimC$1(this._do_check_component_template$_el_0);
        t1 = S.createAndAppend(doc, "p", this._do_check_component_template$_el_0);
        this._do_check_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._text_2 = t1;
        this._do_check_component_template$_el_1.appendChild(t1);
        t1 = S.createAndAppend(doc, "h4", this._do_check_component_template$_el_0);
        this._do_check_component_template$_el_3 = t1;
        this.addShimE$1(t1);
        _text_4 = doc.createTextNode("-- Change Log --");
        this._do_check_component_template$_el_3.appendChild(_text_4);
        _anchor_5 = $.$get$ngAnchor().cloneNode(false);
        this._do_check_component_template$_el_0.appendChild(_anchor_5);
        t1 = new V.ViewContainer(5, 0, this, _anchor_5, null, null, null);
        this._do_check_component_template$_appEl_5 = t1;
        this._NgFor_5_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, M.do_check_component_template__viewFactory_DoCheckComponent1$closure()));
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx, currVal_1, t1, t2, currVal_0;
        _ctx = this.ctx;
        currVal_1 = _ctx.get$changeLog();
        if (this._do_check_component_template$_expr_1 !== currVal_1) {
          this._NgFor_5_7.set$ngForOf(currVal_1);
          this._do_check_component_template$_expr_1 = currVal_1;
        }
        this._NgFor_5_7.ngDoCheck$0();
        this._do_check_component_template$_appEl_5.detectChangesInNestedViews$0();
        t1 = J.get$name$x(_ctx.get$hero());
        t2 = _ctx.get$power();
        t1 = (t1 == null ? "" : H.S(t1)) + " can ";
        currVal_0 = t1 + (t2 == null ? "" : H.S(t2));
        if (this._do_check_component_template$_expr_0 !== currVal_0) {
          this._text_2.textContent = currVal_0;
          this._do_check_component_template$_expr_0 = currVal_0;
        }
      },
      destroyInternal$0: function() {
        var t1 = this._do_check_component_template$_appEl_5;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
      },
      static: {
        ViewDoCheckComponent0$: function(parentView, parentIndex) {
          var t1 = new M.ViewDoCheckComponent0(null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewDoCheckComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewDoCheckComponent1: {
      "^": "AppView;_do_check_component_template$_el_0,_do_check_component_template$_text_1,_do_check_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        t1 = doc.createElement("div");
        ...
        this.addShimC$1(t1);
        t1 = doc.createTextNode("");
        this._do_check_component_template$_text_1 = t1;
        this._do_check_component_template$_el_0.appendChild(t1);
        this.init0$1(this._do_check_component_template$_el_0);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0 = Q.interpolate0(this.locals.$index(0, "$implicit"));
        if (this._do_check_component_template$_expr_0 !== currVal_0) {
          this._do_check_component_template$_text_1.textContent = currVal_0;
          this._do_check_component_template$_expr_0 = currVal_0;
        }
      }
    },
    _ViewDoCheckComponentHost0: {
      "^": "AppView;_do_check_component_template$_compView_0,_DoCheckComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = M.ViewDoCheckComponent0$(this, 0);
        this._do_check_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new Q.DoCheckComponent(null, null, false, [], "", "", 0, 0);
        this._DoCheckComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._DoCheckComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_DoCheckComponent_IGs && 0 === nodeIndex)
          return this._DoCheckComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._DoCheckComponent_0_4.ngDoCheck$0();
        this._do_check_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._do_check_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    },
    ViewDoCheckParentComponent0: {
      "^": "AppView;_viewQuery_DoCheckComponent_0,_do_check_component_template$_el_0,_do_check_component_template$_el_1,_text_2,_do_check_component_template$_el_3,_do_check_component_template$_el_4,_do_check_component_template$_el_5,_do_check_component_template$_el_6,_do_check_component_template$_el_8,_el_9,_DefaultValueAccessor_9_4,_NgValueAccessor_9_5,_NgModel_9_6,_el_10,_el_11,_el_13,_el_14,_DefaultValueAccessor_14_4,_NgValueAccessor_14_5,_NgModel_14_6,_el_15,_el_16,_el_18,_compView_18,_DoCheckComponent_18_4,_do_check_component_template$_expr_0,_do_check_component_template$_expr_3,_do_check_component_template$_expr_4,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewDoCheckParentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("do-check-parent");
        this.rootEl = t1;
        t1 = $.ViewDoCheckParentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_MuZ);
          $.ViewDoCheckParentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_7, t2, _text_12, _text_17, subscription_0, subscription_1;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._do_check_component_template$_el_0 = t1;
        J.set$className$x(t1, "parent");
        this.addShimC$1(this._do_check_component_template$_el_0);
        t1 = S.createAndAppend(doc, "h2", this._do_check_component_template$_el_0);
        this._do_check_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._text_2 = t1;
        this._do_check_component_template$_el_1.appendChild(t1);
        t1 = S.createAndAppend(doc, "table", this._do_check_component_template$_el_0);
        this._do_check_component_template$_el_3 = t1;
        this.addShimC$1(t1);
        t1 = S.createAndAppend(doc, "tbody", this._do_check_component_template$_el_3);
        this._do_check_component_template$_el_4 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "tr", this._do_check_component_template$_el_4);
        this._do_check_component_template$_el_5 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "td", this._do_check_component_template$_el_5);
        this._do_check_component_template$_el_6 = t1;
        this.addShimE$1(t1);
        _text_7 = doc.createTextNode("Power:");
        this._do_check_component_template$_el_6.appendChild(_text_7);
        t1 = S.createAndAppend(doc, "td", this._do_check_component_template$_el_5);
        this._do_check_component_template$_el_8 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "input", this._do_check_component_template$_el_8);
        this._el_9 = t1;
        this.addShimC$1(t1);
        t1 = new O.DefaultValueAccessor(this._el_9, new O.closure0(), new O.closure1());
        this._DefaultValueAccessor_9_4 = t1;
        t1 = [t1];
        this._NgValueAccessor_9_5 = t1;
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._NgModel_9_6 = t2;
        t2 = S.createAndAppend(doc, "tr", this._do_check_component_template$_el_4);
        this._el_10 = t2;
        this.addShimE$1(t2);
        t2 = S.createAndAppend(doc, "td", this._el_10);
        this._el_11 = t2;
        this.addShimE$1(t2);
        _text_12 = doc.createTextNode("Hero.name:");
        this._el_11.appendChild(_text_12);
        t2 = S.createAndAppend(doc, "td", this._el_10);
        this._el_13 = t2;
        this.addShimE$1(t2);
        t2 = S.createAndAppend(doc, "input", this._el_13);
        this._el_14 = t2;
        this.addShimC$1(t2);
        t2 = new O.DefaultValueAccessor(this._el_14, new O.closure0(), new O.closure1());
        this._DefaultValueAccessor_14_4 = t2;
        t2 = [t2];
        this._NgValueAccessor_14_5 = t2;
        t1 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t1._init$1(t2);
        this._NgModel_14_6 = t1;
        t1 = S.createAndAppend(doc, "p", this._do_check_component_template$_el_0);
        this._el_15 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "button", this._el_15);
        this._el_16 = t1;
        this.addShimC$1(t1);
        _text_17 = doc.createTextNode("Reset Log");
        this._el_16.appendChild(_text_17);
        t1 = M.ViewDoCheckComponent0$(this, 18);
        this._compView_18 = t1;
        t1 = t1.rootEl;
        this._el_18 = t1;
        this._do_check_component_template$_el_0.appendChild(t1);
        this.addShimC$1(this._el_18);
        t1 = new Q.DoCheckComponent(null, null, false, [], "", "", 0, 0);
        this._DoCheckComponent_18_4 = t1;
        t2 = this._compView_18;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        J._addEventListener$3$x(this._el_9, "input", this.eventHandler1$1(this.get$_handle_input_9_1()), null);
        J._addEventListener$3$x(this._el_9, "blur", this.eventHandler0$1(this._DefaultValueAccessor_9_4.get$touchHandler()), null);
        t1 = this._NgModel_9_6._update;
        t1.toString;
        subscription_0 = new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_9_0()));
        ...
        t1 = this._NgModel_14_6._update;
        t1.toString;
        subscription_1 = new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_14_0()));
        J._addEventListener$3$x(this._el_16, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        t1 = this._viewQuery_DoCheckComponent_0;
        t1.reset$1(0, [this._DoCheckComponent_18_4]);
        t2 = this.ctx;
        t2.set$childView(J.get$isNotEmpty$asx(t1._results) ? J.get$first$ax(t1._results) : null);
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        ...
        if (t2 && 9 === nodeIndex)
          return this._NgValueAccessor_9_5;
        t3 = token !== C.Type_NgModel_qx4;
        if ((!t3 || token === C.Type_NgControl_GNi) && 9 === nodeIndex)
          return this._NgModel_9_6;
        if (t1 && 14 === nodeIndex)
          return this._DefaultValueAccessor_14_4;
        if (t2 && 14 === nodeIndex)
          return this._NgValueAccessor_14_5;
        if ((!t3 || token === C.Type_NgControl_GNi) && 14 === nodeIndex)
          return this._NgModel_14_6;
        if (token === C.Type_DoCheckComponent_IGs && 18 === nodeIndex)
          return this._DoCheckComponent_18_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, t1, currVal_3, currVal_4, currVal_0;
        _ctx = this.ctx;
        firstCheck = this.viewData._cdState === 0;
        this._NgModel_9_6.set$model(_ctx.get$power());
        this._NgModel_9_6.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgModel_9_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        this._NgModel_14_6.set$model(J.get$name$x(_ctx.get$hero()));
        this._NgModel_14_6.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgModel_14_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        currVal_3 = _ctx.get$hero();
        t1 = this._do_check_component_template$_expr_3;
        if (t1 == null ? currVal_3 != null : t1 !== currVal_3) {
          this._DoCheckComponent_18_4.hero = currVal_3;
          this._do_check_component_template$_expr_3 = currVal_3;
        }
        currVal_4 = _ctx.get$power();
        t1 = this._do_check_component_template$_expr_4;
        if (t1 == null ? currVal_4 != null : t1 !== currVal_4) {
          this._DoCheckComponent_18_4.power = currVal_4;
          this._do_check_component_template$_expr_4 = currVal_4;
        }
        this._DoCheckComponent_18_4.ngDoCheck$0();
        currVal_0 = J.get$title$x(_ctx);
        if (currVal_0 == null)
          currVal_0 = "";
        if (this._do_check_component_template$_expr_0 !== currVal_0) {
          this._text_2.textContent = currVal_0;
      ...
      destroyInternal$0: function() {
        var t1 = this._compView_18;
        if (!(t1 == null))
          t1.destroy$0();
      },
      _handle_ngModelChange_9_0$1: [function($$event) {
        this.ctx.set$power($$event);
      }, "call$1", "get$_handle_ngModelChange_9_0", 2, 0, 4],
      _handle_input_9_1$1: [function($$event) {
        var t1, t2;
        t1 = this._DefaultValueAccessor_9_4;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_input_9_1", 2, 0, 4],
      ...
      static: {
        ViewDoCheckParentComponent0$: function(parentView, parentIndex) {
          var t1 = new M.ViewDoCheckParentComponent0(new D.QueryList(true, C.List_empty, null, [null]), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewDoCheckParentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewDoCheckParentComponentHost0: {
      "^": "AppView;_do_check_component_template$_compView_0,_DoCheckParentComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = M.ViewDoCheckParentComponent0$(this, 0);
        this._do_check_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new Q.DoCheckParentComponent(null, null, "DoCheck", null);
        t1.reset$0(0);
        this._DoCheckParentComponent_0_4 = t1;
        t2 = this._do_check_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._DoCheckParentComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_DoCheckParentComponent_8FR && 0 === nodeIndex)
          return this._DoCheckParentComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._do_check_component_template$_compView_0.detectChanges$0();
  ...
  }], ["", "package:lifecycle_hooks/src/logger_service.dart",, D, {
    "^": "",
    LoggerService: {
      "^": "Object;logs<,_prevMsg,_prevMsgCount",
      log$1: function(msg) {
        var t1, t2, t3;
        t1 = this.logs;
        if (msg === this._prevMsg) {
          t2 = t1.length - 1;
          t3 = msg + " (" + ++this._prevMsgCount + "x)";
      ...
      tick$0: function() {
        return P.Future_Future(new D.LoggerService_tick_closure(), null);
      }
    },
    LoggerService_tick_closure: {
      "^": "Closure:0;",
      call$0: function() {
      }
    }
  }], ["", "package:lifecycle_hooks/src/logger_service.template.dart",, L, {
    "^": "",
    initReflector9: function() {
      ...
      $._visited28 = true;
      E.initReflector0();
      $.$get$_factories().$indexSet(0, C.Type_LoggerService_4CA, new L.initReflector_closure1());
    },
    initReflector_closure1: {
      "^": "Closure:0;",
      call$0: [function() {
        return new D.LoggerService([], "", 1);
      }, null, null, 0, 0, null, "call"]
    }
  }], ["", "package:lifecycle_hooks/src/on_changes_component.dart",, D, {
    "^": "",
    Hero0: {
      "^": "Object;name*",
      toJson$0: function() {
    ...
    OnChangesComponent: {
      "^": "Object;hero@,power@,changeLog<",
      ngOnChanges$1: function(changes) {
        changes.forEach$1(0, new D.OnChangesComponent_ngOnChanges_closure(this));
      },
      reset$0: [function(_) {
        C.JSArray_methods.set$length(this.changeLog, 0);
      }, "call$0", "get$reset", 0, 0, 2]
    },
    OnChangesComponent_ngOnChanges_closure: {
      "^": "Closure:22;$this",
      call$2: function(propName, change) {
        var cur, prev;
        cur = C.JsonCodec_null_null.encode$1(change.get$currentValue());
        prev = change.get$previousValue() == null ? "{}" : C.JsonCodec_null_null.encode$1(change.get$previousValue());
        this.$this.changeLog.push(H.S(propName) + ": currentValue = " + cur + ", previousValue = " + prev);
      }
    },
    OnChangesParentComponent: {
      ...
      reset$0: [function(_) {
        var t1;
        this.hero = new D.Hero0("Windstorm");
        this.power = "sing";
        t1 = this.childView;
        if (!(t1 == null))
          J.reset$0$x(t1);
  ...
  }], ["", "package:lifecycle_hooks/src/on_changes_component.template.dart",, S, {
    "^": "",
    viewFactory_OnChangesComponent1: [function(parentView, parentIndex) {
      var t1 = new S._ViewOnChangesComponent1(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewOnChangesComponent0__renderType;
      return t1;
    }, "call$2", "on_changes_component_template__viewFactory_OnChangesComponent1$closure", 4, 0, 82],
    viewFactory_OnChangesComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewOnChangesComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "on_changes_component_template__viewFactory_OnChangesComponentHost0$closure", 4, 0, 3],
    viewFactory_OnChangesParentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewOnChangesParentComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "on_changes_component_template__viewFactory_OnChangesParentComponentHost0$closure", 4, 0, 3],
    initReflector6: function() {
      ...
      K.initReflector10();
      var t1 = $.$get$_components();
      t1.$indexSet(0, C.Type_OnChangesComponent_EOZ, C.ComponentFactory_H1k);
      t1.$indexSet(0, C.Type_OnChangesParentComponent_mBr, C.ComponentFactory_TH2);
    },
    ViewOnChangesComponent0: {
      "^": "AppView;_on_changes_component_template$_el_0,_on_changes_component_template$_el_1,_on_changes_component_template$_text_2,_on_changes_component_template$_el_3,_on_changes_component_template$_appEl_5,_on_changes_component_template$_NgFor_5_7,_on_changes_component_template$_expr_0,_on_changes_component_template$_expr_1,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewOnChangesComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("on-changes");
        this.rootEl = t1;
        t1 = $.ViewOnChangesComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_PPN);
          $.ViewOnChangesComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._on_changes_component_template$_el_0 = t1;
        J.set$className$x(t1, "hero");
        this.addShimC$1(this._on_changes_component_template$_el_0);
        t1 = S.createAndAppend(doc, "p", this._on_changes_component_template$_el_0);
        this._on_changes_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._on_changes_component_template$_text_2 = t1;
        this._on_changes_component_template$_el_1.appendChild(t1);
        t1 = S.createAndAppend(doc, "h4", this._on_changes_component_template$_el_0);
        this._on_changes_component_template$_el_3 = t1;
        this.addShimE$1(t1);
        _text_4 = doc.createTextNode("-- Change Log --");
        this._on_changes_component_template$_el_3.appendChild(_text_4);
        _anchor_5 = $.$get$ngAnchor().cloneNode(false);
        this._on_changes_component_template$_el_0.appendChild(_anchor_5);
        t1 = new V.ViewContainer(5, 0, this, _anchor_5, null, null, null);
        this._on_changes_component_template$_appEl_5 = t1;
        this._on_changes_component_template$_NgFor_5_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, S.on_changes_component_template__viewFactory_OnChangesComponent1$closure()));
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        ...
        _ctx = this.ctx;
        currVal_1 = _ctx.get$changeLog();
        if (this._on_changes_component_template$_expr_1 !== currVal_1) {
          this._on_changes_component_template$_NgFor_5_7.set$ngForOf(currVal_1);
          this._on_changes_component_template$_expr_1 = currVal_1;
        }
        this._on_changes_component_template$_NgFor_5_7.ngDoCheck$0();
        this._on_changes_component_template$_appEl_5.detectChangesInNestedViews$0();
        t1 = J.get$name$x(_ctx.get$hero());
        t2 = _ctx.get$power();
        t1 = (t1 == null ? "" : H.S(t1)) + " can ";
        currVal_0 = t1 + (t2 == null ? "" : H.S(t2));
        if (this._on_changes_component_template$_expr_0 !== currVal_0) {
          this._on_changes_component_template$_text_2.textContent = currVal_0;
          this._on_changes_component_template$_expr_0 = currVal_0;
        }
      },
      destroyInternal$0: function() {
        var t1 = this._on_changes_component_template$_appEl_5;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
      },
      static: {
        ViewOnChangesComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewOnChangesComponent0(null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewOnChangesComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewOnChangesComponent1: {
      "^": "AppView;_on_changes_component_template$_el_0,_on_changes_component_template$_text_1,_on_changes_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        t1 = doc.createElement("div");
        ...
        this.addShimC$1(t1);
        t1 = doc.createTextNode("");
        this._on_changes_component_template$_text_1 = t1;
        this._on_changes_component_template$_el_0.appendChild(t1);
        this.init0$1(this._on_changes_component_template$_el_0);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0 = Q.interpolate0(this.locals.$index(0, "$implicit"));
        if (this._on_changes_component_template$_expr_0 !== currVal_0) {
          this._on_changes_component_template$_text_1.textContent = currVal_0;
          this._on_changes_component_template$_expr_0 = currVal_0;
        }
      }
    },
    _ViewOnChangesComponentHost0: {
      "^": "AppView;_on_changes_component_template$_compView_0,_OnChangesComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = S.ViewOnChangesComponent0$(this, 0);
        this._on_changes_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new D.OnChangesComponent(null, null, []);
        this._OnChangesComponent_0_4 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._OnChangesComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_OnChangesComponent_EOZ && 0 === nodeIndex)
          return this._OnChangesComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._on_changes_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._on_changes_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    },
    ViewOnChangesParentComponent0: {
      "^": "AppView;_viewQuery_OnChangesComponent_0,_on_changes_component_template$_el_0,_on_changes_component_template$_el_1,_on_changes_component_template$_text_2,_on_changes_component_template$_el_3,_on_changes_component_template$_el_4,_on_changes_component_template$_el_5,_on_changes_component_template$_el_6,_on_changes_component_template$_el_8,_on_changes_component_template$_el_9,_on_changes_component_template$_DefaultValueAccessor_9_4,_on_changes_component_template$_NgValueAccessor_9_5,_on_changes_component_template$_NgModel_9_6,_on_changes_component_template$_el_10,_on_changes_component_template$_el_11,_on_changes_component_template$_el_13,_on_changes_component_template$_el_14,_on_changes_component_template$_DefaultValueAccessor_14_4,_on_changes_component_template$_NgValueAccessor_14_5,_on_changes_component_template$_NgModel_14_6,_on_changes_component_template$_el_15,_on_changes_component_template$_el_16,_on_changes_component_template$_el_18,_on_changes_component_template$_compView_18,_OnChangesComponent_18_4,_on_changes_component_template$_expr_0,_on_changes_component_template$_expr_3,_expr_4,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewOnChangesParentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("on-changes-parent");
        this.rootEl = t1;
        t1 = $.ViewOnChangesParentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_MuZ);
          $.ViewOnChangesParentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        J.set$className$x(t1, "parent");
        this.addShimC$1(this._on_changes_component_template$_el_0);
        t1 = S.createAndAppend(doc, "h2", this._on_changes_component_template$_el_0);
        this._on_changes_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._on_changes_component_template$_text_2 = t1;
        this._on_changes_component_template$_el_1.appendChild(t1);
        t1 = S.createAndAppend(doc, "table", this._on_changes_component_template$_el_0);
        this._on_changes_component_template$_el_3 = t1;
        this.addShimC$1(t1);
        t1 = S.createAndAppend(doc, "tbody", this._on_changes_component_template$_el_3);
        this._on_changes_component_template$_el_4 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "tr", this._on_changes_component_template$_el_4);
        this._on_changes_component_template$_el_5 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "td", this._on_changes_component_template$_el_5);
        this._on_changes_component_template$_el_6 = t1;
        this.addShimE$1(t1);
        _text_7 = doc.createTextNode("Power:");
        this._on_changes_component_template$_el_6.appendChild(_text_7);
        t1 = S.createAndAppend(doc, "td", this._on_changes_component_template$_el_5);
        this._on_changes_component_template$_el_8 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "input", this._on_changes_component_template$_el_8);
        this._on_changes_component_template$_el_9 = t1;
        this.addShimC$1(t1);
        t1 = new O.DefaultValueAccessor(this._on_changes_component_template$_el_9, new O.closure0(), new O.closure1());
        this._on_changes_component_template$_DefaultValueAccessor_9_4 = t1;
        t1 = [t1];
        this._on_changes_component_template$_NgValueAccessor_9_5 = t1;
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._on_changes_component_template$_NgModel_9_6 = t2;
        t2 = S.createAndAppend(doc, "tr", this._on_changes_component_template$_el_4);
        this._on_changes_component_template$_el_10 = t2;
        this.addShimE$1(t2);
        t2 = S.createAndAppend(doc, "td", this._on_changes_component_template$_el_10);
        this._on_changes_component_template$_el_11 = t2;
        this.addShimE$1(t2);
        _text_12 = doc.createTextNode("Hero.name:");
        this._on_changes_component_template$_el_11.appendChild(_text_12);
        t2 = S.createAndAppend(doc, "td", this._on_changes_component_template$_el_10);
        this._on_changes_component_template$_el_13 = t2;
        this.addShimE$1(t2);
        t2 = S.createAndAppend(doc, "input", this._on_changes_component_template$_el_13);
        this._on_changes_component_template$_el_14 = t2;
        this.addShimC$1(t2);
        t2 = new O.DefaultValueAccessor(this._on_changes_component_template$_el_14, new O.closure0(), new O.closure1());
        this._on_changes_component_template$_DefaultValueAccessor_14_4 = t2;
        t2 = [t2];
        this._on_changes_component_template$_NgValueAccessor_14_5 = t2;
        t1 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t1._init$1(t2);
        this._on_changes_component_template$_NgModel_14_6 = t1;
        t1 = S.createAndAppend(doc, "p", this._on_changes_component_template$_el_0);
        this._on_changes_component_template$_el_15 = t1;
        this.addShimE$1(t1);
        t1 = S.createAndAppend(doc, "button", this._on_changes_component_template$_el_15);
        this._on_changes_component_template$_el_16 = t1;
        this.addShimC$1(t1);
        _text_17 = doc.createTextNode("Reset Log");
        this._on_changes_component_template$_el_16.appendChild(_text_17);
        t1 = S.ViewOnChangesComponent0$(this, 18);
        this._on_changes_component_template$_compView_18 = t1;
        t1 = t1.rootEl;
        this._on_changes_component_template$_el_18 = t1;
        this._on_changes_component_template$_el_0.appendChild(t1);
        this.addShimC$1(this._on_changes_component_template$_el_18);
        t1 = new D.OnChangesComponent(null, null, []);
        this._OnChangesComponent_18_4 = t1;
        t2 = this._on_changes_component_template$_compView_18;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        J._addEventListener$3$x(this._on_changes_component_template$_el_9, "input", this.eventHandler1$1(this.get$_on_changes_component_template$_handle_input_9_1()), null);
        J._addEventListener$3$x(this._on_changes_component_template$_el_9, "blur", this.eventHandler0$1(this._on_changes_component_template$_DefaultValueAccessor_9_4.get$touchHandler()), null);
        t1 = this._on_changes_component_template$_NgModel_9_6._update;
        t1.toString;
        subscription_0 = new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_on_changes_component_template$_handle_ngModelChange_9_0()));
        J._addEventListener$3$x(this._on_changes_component_template$_el_14, "input", this.eventHandler1$1(this.get$_on_changes_component_template$_handle_input_14_1()), null);
        J._addEventListener$3$x(this._on_changes_component_template$_el_14, "blur", this.eventHandler0$1(this._on_changes_component_template$_DefaultValueAccessor_14_4.get$touchHandler()), null);
        t1 = this._on_changes_component_template$_NgModel_14_6._update;
        t1.toString;
        subscription_1 = new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_on_changes_component_template$_handle_ngModelChange_14_0()));
        J._addEventListener$3$x(this._on_changes_component_template$_el_16, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        t1 = this._viewQuery_OnChangesComponent_0;
        t1.reset$1(0, [this._OnChangesComponent_18_4]);
        t2 = this.ctx;
        t2.set$childView(J.get$isNotEmpty$asx(t1._results) ? J.get$first$ax(t1._results) : null);
        this.init$2(C.List_empty, [subscription_0, subscription_1]);
        return;
      ...
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        ...
        t1 = token === C.Type_DefaultValueAccessor_EOZ;
        if (t1 && 9 === nodeIndex)
          return this._on_changes_component_template$_DefaultValueAccessor_9_4;
        t2 = token === C.OpaqueToken_NgValueAccessor;
        if (t2 && 9 === nodeIndex)
          return this._on_changes_component_template$_NgValueAccessor_9_5;
        t3 = token !== C.Type_NgModel_qx4;
        if ((!t3 || token === C.Type_NgControl_GNi) && 9 === nodeIndex)
          return this._on_changes_component_template$_NgModel_9_6;
        if (t1 && 14 === nodeIndex)
          return this._on_changes_component_template$_DefaultValueAccessor_14_4;
        if (t2 && 14 === nodeIndex)
          return this._on_changes_component_template$_NgValueAccessor_14_5;
        if ((!t3 || token === C.Type_NgControl_GNi) && 14 === nodeIndex)
          return this._on_changes_component_template$_NgModel_14_6;
        if (token === C.Type_OnChangesComponent_EOZ && 18 === nodeIndex)
          return this._OnChangesComponent_18_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, t1, currVal_3, changes, currVal_4, currVal_0;
        _ctx = this.ctx;
        firstCheck = this.viewData._cdState === 0;
        this._on_changes_component_template$_NgModel_9_6.set$model(_ctx.get$power());
        this._on_changes_component_template$_NgModel_9_6.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._on_changes_component_template$_NgModel_9_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        this._on_changes_component_template$_NgModel_14_6.set$model(J.get$name$x(_ctx.get$hero()));
        this._on_changes_component_template$_NgModel_14_6.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._on_changes_component_template$_NgModel_14_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        currVal_3 = _ctx.get$hero();
        t1 = this._on_changes_component_template$_expr_3;
        if (t1 == null ? currVal_3 != null : t1 !== currVal_3) {
          this._OnChangesComponent_18_4.hero = currVal_3;
          changes = P.LinkedHashMap_LinkedHashMap$_empty(P.String, A.SimpleChange);
          changes.$indexSet(0, "hero", new A.SimpleChange(t1, currVal_3));
          this._on_changes_component_template$_expr_3 = currVal_3;
        } else
          changes = null;
        currVal_4 = _ctx.get$power();
        t1 = this._expr_4;
        if (t1 == null ? currVal_4 != null : t1 !== currVal_4) {
          this._OnChangesComponent_18_4.power = currVal_4;
          if (changes == null)
            changes = P.LinkedHashMap_LinkedHashMap$_empty(P.String, A.SimpleChange);
          changes.$indexSet(0, "power", new A.SimpleChange(t1, currVal_4));
          this._expr_4 = currVal_4;
        }
        if (changes != null)
          this._OnChangesComponent_18_4.ngOnChanges$1(changes);
        currVal_0 = J.get$title$x(_ctx);
        if (currVal_0 == null)
          currVal_0 = "";
        if (this._on_changes_component_template$_expr_0 !== currVal_0) {
        ...
        this._on_changes_component_template$_compView_18.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._on_changes_component_template$_compView_18;
        if (!(t1 == null))
          t1.destroy$0();
      },
      _on_changes_component_template$_handle_ngModelChange_9_0$1: [function($$event) {
        this.ctx.set$power($$event);
      }, "call$1", "get$_on_changes_component_template$_handle_ngModelChange_9_0", 2, 0, 4],
      _on_changes_component_template$_handle_input_9_1$1: [function($$event) {
        var t1, t2;
        t1 = this._on_changes_component_template$_DefaultValueAccessor_9_4;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_on_changes_component_template$_handle_input_9_1", 2, 0, 4],
      _on_changes_component_template$_handle_ngModelChange_14_0$1: [function($$event) {
        J.set$name$x(this.ctx.get$hero(), $$event);
      }, "call$1", "get$_on_changes_component_template$_handle_ngModelChange_14_0", 2, 0, 4],
      _on_changes_component_template$_handle_input_14_1$1: [function($$event) {
        var t1, t2;
        t1 = this._on_changes_component_template$_DefaultValueAccessor_14_4;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_on_changes_component_template$_handle_input_14_1", 2, 0, 4],
      static: {
        ViewOnChangesParentComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewOnChangesParentComponent0(new D.QueryList(true, C.List_empty, null, [null]), null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewOnChangesParentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewOnChangesParentComponentHost0: {
      "^": "AppView;_on_changes_component_template$_compView_0,_OnChangesParentComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = S.ViewOnChangesParentComponent0$(this, 0);
        this._on_changes_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = new D.OnChangesParentComponent(null, null, "OnChanges", null);
        t1.reset$0(0);
        this._OnChangesParentComponent_0_4 = t1;
        t2 = this._on_changes_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._OnChangesParentComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_OnChangesParentComponent_mBr && 0 === nodeIndex)
          return this._OnChangesParentComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._on_changes_component_template$_compView_0.detectChanges$0();
  ...
  }], ["", "package:lifecycle_hooks/src/peek_a_boo_component.dart",, S, {
    "^": "",
    PeekABoo: {
      "^": "Object;"
    },
    PeekABooComponent: {
      "^": "PeekABoo;name*,_afterContentCheckedCounter,_afterViewCheckedCounter,_onChangesCounter,_verb,_peek_a_boo_component$_logger",
      PeekABooComponent$1: function(logger) {
        var t1, t2;
        t1 = "name " + (this.name != null ? "is" : "is not") + " known at construction";
        t2 = $._nextId;
        $._nextId = t2 + 1;
        this._peek_a_boo_component$_logger.log$1("#" + t2 + " " + t1);
      },
      ngOnChanges$1: function(changes) {
        var messages, t1, t2;
        messages = [];
        changes.forEach$1(0, new S.PeekABooComponent_ngOnChanges_closure(this, changes, messages));
        t1 = "OnChanges (" + this._onChangesCounter++ + "): " + C.JSArray_methods.join$1(messages, "; ");
        t2 = $._nextId;
        $._nextId = t2 + 1;
        this._peek_a_boo_component$_logger.log$1("#" + t2 + " " + t1);
        this._verb = "changed";
      ...
      static: {
        PeekABooComponent$: function(logger) {
          var t1 = new S.PeekABooComponent(null, 1, 1, 1, "initialized", logger);
          t1.PeekABooComponent$1(logger);
          return t1;
        }
      }
    },
    PeekABooComponent_ngOnChanges_closure: {
      "^": "Closure:22;$this,changes,messages",
      call$2: function(propName, change) {
        var t1, t2, $name;
        t1 = this.messages;
        t2 = this.$this;
        if (J.$eq$(propName, "name")) {
          $name = this.changes.$index(0, "name").get$currentValue();
          t1.push("name " + t2._verb + ' to "' + H.S($name) + '"');
        } else
          t1.push(H.S(propName) + " " + t2._verb);
      }
    }
  }], ["", "package:lifecycle_hooks/src/peek_a_boo_component.template.dart",, X, {
    "^": "",
    viewFactory_PeekABooComponentHost0: [function(parentView, parentIndex) {
      var t1 = new X._ViewPeekABooComponentHost0(null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "peek_a_boo_component_template__viewFactory_PeekABooComponentHost0$closure", 4, 0, 3],
    initReflector36: function() {
      ...
      L.initReflector9();
      E.initReflector0();
      $.$get$_components().$indexSet(0, C.Type_PeekABooComponent_Q3l, C.ComponentFactory_ClA);
    },
    ViewPeekABooComponent0: {
      "^": "AppView;_peek_a_boo_component_template$_el_0,_peek_a_boo_component_template$_text_1,_peek_a_boo_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewPeekABooComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("peek-a-boo");
        this.rootEl = t1;
        t1 = $.ViewPeekABooComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_ypT);
          $.ViewPeekABooComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        ...
        this._peek_a_boo_component_template$_el_0 = t1;
        this.addShimE$1(t1);
        t1 = doc.createTextNode("");
        this._peek_a_boo_component_template$_text_1 = t1;
        this._peek_a_boo_component_template$_el_0.appendChild(t1);
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var t1, currVal_0;
        t1 = J.get$name$x(this.ctx);
        currVal_0 = "Now you see my hero, " + (t1 == null ? "" : H.S(t1));
        if (this._peek_a_boo_component_template$_expr_0 !== currVal_0) {
          this._peek_a_boo_component_template$_text_1.textContent = currVal_0;
          this._peek_a_boo_component_template$_expr_0 = currVal_0;
        }
      },
      static: {
        ViewPeekABooComponent0$: function(parentView, parentIndex) {
          var t1 = new X.ViewPeekABooComponent0(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewPeekABooComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewPeekABooComponentHost0: {
      "^": "AppView;_peek_a_boo_component_template$_compView_0,_PeekABooComponent_0_4,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = X.ViewPeekABooComponent0$(this, 0);
        this._peek_a_boo_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t1 = S.PeekABooComponent$(this.injectorGet$2(C.Type_LoggerService_4CA, this.viewData.parentIndex));
        this._PeekABooComponent_0_4 = t1;
        t2 = this._peek_a_boo_component_template$_compView_0;
        t3 = this.viewData.projectableNodes;
        t2.ctx = t1;
        t2.viewData.projectableNodes = t3;
        t2.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._PeekABooComponent_0_4);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_PeekABooComponent_Q3l && 0 === nodeIndex)
          return this._PeekABooComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var firstCheck, t1, t2, t3;
        firstCheck = this.viewData._cdState === 0;
        if (firstCheck) {
          t1 = this._PeekABooComponent_0_4._peek_a_boo_component$_logger;
          t2 = $._nextId;
          $._nextId = t2 + 1;
          t1.log$1("#" + t2 + " OnInit");
        }
        ...
        if (firstCheck) {
          ...
          t2 = $._nextId;
          $._nextId = t2 + 1;
          t1.log$1("#" + t2 + " AfterContentInit");
        }
        t1 = this._PeekABooComponent_0_4;
        t2 = "AfterContentChecked (" + t1._afterContentCheckedCounter++ + ")";
        t1 = t1._peek_a_boo_component$_logger;
        t3 = $._nextId;
        $._nextId = t3 + 1;
        t1.log$1("#" + t3 + " " + t2);
        this._peek_a_boo_component_template$_compView_0.detectChanges$0();
        if (firstCheck) {
          t1 = this._PeekABooComponent_0_4._peek_a_boo_component$_logger;
          t2 = $._nextId;
          $._nextId = t2 + 1;
          t1.log$1("#" + t2 + " AfterViewInit");
        }
        t1 = this._PeekABooComponent_0_4;
        t2 = "AfterViewChecked (" + t1._afterViewCheckedCounter++ + ")";
        t1 = t1._peek_a_boo_component$_logger;
        t3 = $._nextId;
        $._nextId = t3 + 1;
        t1.log$1("#" + t3 + " " + t2);
      ...
      destroyInternal$0: function() {
        var t1, t2;
        t1 = this._peek_a_boo_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._PeekABooComponent_0_4._peek_a_boo_component$_logger;
        t2 = $._nextId;
        $._nextId = t2 + 1;
        t1.log$1("#" + t2 + " OnDestroy");
      }
    }
  }], ["", "package:lifecycle_hooks/src/peek_a_boo_parent_component.dart",, V, {
    "^": "",
    PeekABooParentComponent: {
      "^": "Object;_peek_a_boo_parent_component$_logger,hasChild<,heroName<",
      get$logs: function() {
        return this._peek_a_boo_parent_component$_logger.logs;
      },
      toggleChild$0: [function() {
        var t1 = !this.hasChild;
        this.hasChild = t1;
        if (t1) {
          this.heroName = "Windstorm";
          C.JSArray_methods.set$length(this._peek_a_boo_parent_component$_logger.logs, 0);
        }
        this._peek_a_boo_parent_component$_logger.tick$0();
      }, "call$0", "get$toggleChild", 0, 0, 0],
      updateHero$0: [function() {
        this.heroName += "!";
        this._peek_a_boo_parent_component$_logger.tick$0();
      }, "call$0", "get$updateHero", 0, 0, 0]
    }
  }], ["", "package:lifecycle_hooks/src/peek_a_boo_parent_component.template.dart",, A, {
    "^": "",
    viewFactory_PeekABooParentComponent1: [function(parentView, parentIndex) {
      var t1 = new A._ViewPeekABooParentComponent1(null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewPeekABooParentComponent0__renderType;
      return t1;
    }, "call$2", "peek_a_boo_parent_component_template__viewFactory_PeekABooParentComponent1$closure", 4, 0, 11],
    viewFactory_PeekABooParentComponent2: [function(parentView, parentIndex) {
      var t1 = new A._ViewPeekABooParentComponent2(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewPeekABooParentComponent0__renderType;
      return t1;
    }, "call$2", "peek_a_boo_parent_component_template__viewFactory_PeekABooParentComponent2$closure", 4, 0, 11],
    viewFactory_PeekABooParentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new A._ViewPeekABooParentComponentHost0(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "peek_a_boo_parent_component_template__viewFactory_PeekABooParentComponentHost0$closure", 4, 0, 3],
    initReflector7: function() {
      ...
      K.initReflector10();
      X.initReflector36();
      $.$get$_components().$indexSet(0, C.Type_PeekABooParentComponent_PPf, C.ComponentFactory_nBh);
    },
    ViewPeekABooParentComponent0: {
      "^": "AppView;_peek_a_boo_parent_component_template$_el_0,_peek_a_boo_parent_component_template$_el_1,_peek_a_boo_parent_component_template$_el_3,_text_4,_peek_a_boo_parent_component_template$_el_5,_appEl_7,_NgIf_7_7,_peek_a_boo_parent_component_template$_el_8,_peek_a_boo_parent_component_template$_appEl_10,_peek_a_boo_parent_component_template$_NgFor_10_7,_peek_a_boo_parent_component_template$_expr_0,_peek_a_boo_parent_component_template$_expr_1,_expr_3,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewPeekABooParentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("peek-a-boo-parent");
        this.rootEl = t1;
        t1 = $.ViewPeekABooParentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_MuZ0);
          $.ViewPeekABooParentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_2, _text_6, _anchor_7, t2, _text_9, _anchor_10;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._peek_a_boo_parent_component_template$_el_0 = t1;
        J.set$className$x(t1, "parent");
        this.addShimC$1(this._peek_a_boo_parent_component_template$_el_0);
        t1 = S.createAndAppend(doc, "h2", this._peek_a_boo_parent_component_template$_el_0);
        this._peek_a_boo_parent_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        _text_2 = doc.createTextNode("Peek-A-Boo");
        this._peek_a_boo_parent_component_template$_el_1.appendChild(_text_2);
        t1 = S.createAndAppend(doc, "button", this._peek_a_boo_parent_component_template$_el_0);
        this._peek_a_boo_parent_component_template$_el_3 = t1;
        this.addShimC$1(t1);
        t1 = doc.createTextNode("");
        this._text_4 = t1;
        this._peek_a_boo_parent_component_template$_el_3.appendChild(t1);
        t1 = S.createAndAppend(doc, "button", this._peek_a_boo_parent_component_template$_el_0);
        this._peek_a_boo_parent_component_template$_el_5 = t1;
        this.addShimC$1(t1);
        _text_6 = doc.createTextNode("Update Hero");
        this._peek_a_boo_parent_component_template$_el_5.appendChild(_text_6);
        t1 = $.$get$ngAnchor();
        _anchor_7 = t1.cloneNode(false);
        this._peek_a_boo_parent_component_template$_el_0.appendChild(_anchor_7);
        t2 = new V.ViewContainer(7, 0, this, _anchor_7, null, null, null);
        this._appEl_7 = t2;
        this._NgIf_7_7 = new K.NgIf(new D.TemplateRef(t2, A.peek_a_boo_parent_component_template__viewFactory_PeekABooParentComponent1$closure()), t2, false);
        t2 = S.createAndAppend(doc, "h4", this._peek_a_boo_parent_component_template$_el_0);
        this._peek_a_boo_parent_component_template$_el_8 = t2;
        this.addShimE$1(t2);
        _text_9 = doc.createTextNode("-- Lifecycle Hook Log --");
        this._peek_a_boo_parent_component_template$_el_8.appendChild(_text_9);
        _anchor_10 = t1.cloneNode(false);
        this._peek_a_boo_parent_component_template$_el_0.appendChild(_anchor_10);
        t1 = new V.ViewContainer(10, 0, this, _anchor_10, null, null, null);
        this._peek_a_boo_parent_component_template$_appEl_10 = t1;
        this._peek_a_boo_parent_component_template$_NgFor_10_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, A.peek_a_boo_parent_component_template__viewFactory_PeekABooParentComponent2$closure()));
        J._addEventListener$3$x(this._peek_a_boo_parent_component_template$_el_3, "click", this.eventHandler0$1(this.ctx.get$toggleChild()), null);
        J._addEventListener$3$x(this._peek_a_boo_parent_component_template$_el_5, "click", this.eventHandler0$1(this.ctx.get$updateHero()), null);
        this.init$2(C.List_empty, null);
        return;
      },
      detectChangesInternal$0: function() {
        var _ctx, currVal_3, t1, currVal_0, currVal_1;
        _ctx = this.ctx;
        this._NgIf_7_7.set$ngIf(_ctx.get$hasChild());
        currVal_3 = _ctx.get$logs();
        if (this._expr_3 !== currVal_3) {
          this._peek_a_boo_parent_component_template$_NgFor_10_7.set$ngForOf(currVal_3);
          this._expr_3 = currVal_3;
        }
        this._peek_a_boo_parent_component_template$_NgFor_10_7.ngDoCheck$0();
        this._appEl_7.detectChangesInNestedViews$0();
        this._peek_a_boo_parent_component_template$_appEl_10.detectChangesInNestedViews$0();
        t1 = _ctx.get$hasChild() ? "Destroy " : "Create ";
        currVal_0 = t1 + "PeekABooComponent";
        if (this._peek_a_boo_parent_component_template$_expr_0 !== currVal_0) {
          this._text_4.textContent = currVal_0;
          this._peek_a_boo_parent_component_template$_expr_0 = currVal_0;
        }
        currVal_1 = !_ctx.get$hasChild();
        if (this._peek_a_boo_parent_component_template$_expr_1 !== currVal_1) {
          this._peek_a_boo_parent_component_template$_el_5.hidden = currVal_1;
          this._peek_a_boo_parent_component_template$_expr_1 = currVal_1;
        }
      },
      destroyInternal$0: function() {
        ...
        if (!(t1 == null))
          t1.destroyNestedViews$0();
        t1 = this._peek_a_boo_parent_component_template$_appEl_10;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
      },
      static: {
        ViewPeekABooParentComponent0$: function(parentView, parentIndex) {
          var t1 = new A.ViewPeekABooParentComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewPeekABooParentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewPeekABooParentComponent1: {
      "^": "AppView;_peek_a_boo_parent_component_template$_el_0,_peek_a_boo_parent_component_template$_compView_0,_peek_a_boo_parent_component_template$_PeekABooComponent_0_4,_peek_a_boo_parent_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2;
        t1 = X.ViewPeekABooComponent0$(this, 0);
        this._peek_a_boo_parent_component_template$_compView_0 = t1;
        t1 = t1.rootEl;
        this._peek_a_boo_parent_component_template$_el_0 = t1;
        this.addShimC$1(t1);
        t1 = this.parentView;
        t1 = S.PeekABooComponent$(t1.parentView.injectorGet$2(C.Type_LoggerService_4CA, t1.viewData.parentIndex));
        this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4 = t1;
        t2 = this._peek_a_boo_parent_component_template$_compView_0;
        t2.ctx = t1;
        t2.viewData.projectableNodes = [];
        t2.build$0();
        this.init0$1(this._peek_a_boo_parent_component_template$_el_0);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_PeekABooComponent_Q3l && 0 === nodeIndex)
          return this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, currVal_0, t1, changes, t2, t3;
        _ctx = this.ctx;
        firstCheck = this.viewData._cdState === 0;
        currVal_0 = _ctx.get$heroName();
        t1 = this._peek_a_boo_parent_component_template$_expr_0;
        if (t1 !== currVal_0) {
          this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4.name = currVal_0;
          changes = P.LinkedHashMap_LinkedHashMap$_empty(P.String, A.SimpleChange);
          changes.$indexSet(0, "name", new A.SimpleChange(t1, currVal_0));
          this._peek_a_boo_parent_component_template$_expr_0 = currVal_0;
        } else
          changes = null;
        if (changes != null)
          this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4.ngOnChanges$1(changes);
        if (firstCheck) {
          t1 = this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4._peek_a_boo_component$_logger;
          t2 = $._nextId;
          $._nextId = t2 + 1;
          t1.log$1("#" + t2 + " OnInit");
        }
        ...
        t1 = this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4;
        t2 = "AfterContentChecked (" + t1._afterContentCheckedCounter++ + ")";
        t1 = t1._peek_a_boo_component$_logger;
        t3 = $._nextId;
        $._nextId = t3 + 1;
        t1.log$1("#" + t3 + " " + t2);
        this._peek_a_boo_parent_component_template$_compView_0.detectChanges$0();
        if (firstCheck) {
          t1 = this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4._peek_a_boo_component$_logger;
          t2 = $._nextId;
          $._nextId = t2 + 1;
      ...
      destroyInternal$0: function() {
        var t1, t2;
        t1 = this._peek_a_boo_parent_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
        t1 = this._peek_a_boo_parent_component_template$_PeekABooComponent_0_4._peek_a_boo_component$_logger;
        t2 = $._nextId;
    ...
    _ViewPeekABooParentComponent2: {
      "^": "AppView;_peek_a_boo_parent_component_template$_el_0,_peek_a_boo_parent_component_template$_text_1,_peek_a_boo_parent_component_template$_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        t1 = doc.createElement("div");
        ...
        this.addShimC$1(t1);
        t1 = doc.createTextNode("");
        this._peek_a_boo_parent_component_template$_text_1 = t1;
        this._peek_a_boo_parent_component_template$_el_0.appendChild(t1);
        this.init0$1(this._peek_a_boo_parent_component_template$_el_0);
        return;
      },
      detectChangesInternal$0: function() {
        var currVal_0 = Q.interpolate0(this.locals.$index(0, "$implicit"));
        if (this._peek_a_boo_parent_component_template$_expr_0 !== currVal_0) {
          this._peek_a_boo_parent_component_template$_text_1.textContent = currVal_0;
          this._peek_a_boo_parent_component_template$_expr_0 = currVal_0;
        }
      }
    },
    _ViewPeekABooParentComponentHost0: {
      "^": "AppView;_peek_a_boo_parent_component_template$_compView_0,_peek_a_boo_parent_component_template$_LoggerService_0_4,_PeekABooParentComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = A.ViewPeekABooParentComponent0$(this, 0);
        this._peek_a_boo_parent_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new D.LoggerService([], "", 1);
        this._peek_a_boo_parent_component_template$_LoggerService_0_4 = t2;
        t2 = new V.PeekABooParentComponent(t2, false, "Windstorm");
        this._PeekABooParentComponent_0_5 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._PeekABooParentComponent_0_5);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_LoggerService_4CA && 0 === nodeIndex)
          return this._peek_a_boo_parent_component_template$_LoggerService_0_4;
        if (token === C.Type_PeekABooParentComponent_PPf && 0 === nodeIndex)
          return this._PeekABooParentComponent_0_5;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._peek_a_boo_parent_component_template$_compView_0.detectChanges$0();
      ...
      destroyInternal$0: function() {
        var t1 = this._peek_a_boo_parent_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    }
  }], ["", "package:lifecycle_hooks/src/spy_component.dart",, X, {
    "^": "",
    SpyParentComponent: {
      "^": "Object;_spy_component$_logger,newName@,heroes<",
      get$logs: function() {
        return this._spy_component$_logger.logs;
      },
      addHero$0: [function() {
        if (J.trim$0$s(this.newName).length !== 0) {
          this.heroes.push(J.trim$0$s(this.newName));
          this.newName = "";
          this._spy_component$_logger.tick$0();
        }
      }, "call$0", "get$addHero", 0, 0, 0],
      reset$0: [function(_) {
        var t1 = this._spy_component$_logger;
        t1.log$1("-- reset --");
        C.JSArray_methods.set$length(this.heroes, 0);
        t1.tick$0();
      }, "call$0", "get$reset", 0, 0, 2]
    }
  }], ["", "package:lifecycle_hooks/src/spy_component.template.dart",, S, {
    "^": "",
    viewFactory_SpyParentComponent1: [function(parentView, parentIndex) {
      var t1 = new S._ViewSpyParentComponent1(null, null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewSpyParentComponent0__renderType;
      return t1;
    }, "call$2", "spy_component_template__viewFactory_SpyParentComponent1$closure", 4, 0, 21],
    viewFactory_SpyParentComponent2: [function(parentView, parentIndex) {
      var t1 = new S._ViewSpyParentComponent2(null, null, null, null, P.LinkedHashMap__makeLiteral(["$implicit", null]), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_2, parentIndex);
      t1.componentType = $.ViewSpyParentComponent0__renderType;
      return t1;
    }, "call$2", "spy_component_template__viewFactory_SpyParentComponent2$closure", 4, 0, 21],
    viewFactory_SpyParentComponentHost0: [function(parentView, parentIndex) {
      var t1 = new S._ViewSpyParentComponentHost0(null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
      t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_0, parentIndex);
      return t1;
    }, "call$2", "spy_component_template__viewFactory_SpyParentComponentHost0$closure", 4, 0, 3],
    initReflector8: function() {
      ...
      K.initReflector10();
      F.initReflector11();
      $.$get$_components().$indexSet(0, C.Type_SpyParentComponent_Rss, C.ComponentFactory_c9P);
    },
    ViewSpyParentComponent0: {
      "^": "AppView;_spy_component_template$_el_0,_spy_component_template$_el_1,_spy_component_template$_el_3,_DefaultValueAccessor_3_4,_NgValueAccessor_3_5,_NgModel_3_6,_spy_component_template$_el_4,_spy_component_template$_el_6,_spy_component_template$_el_8,_spy_component_template$_appEl_9,_spy_component_template$_NgFor_9_7,_spy_component_template$_el_10,_appEl_12,_NgFor_12_7,_expr_1,_expr_2,viewData,locals,parentView,componentType,rootEl,ctx",
      ViewSpyParentComponent0$2: function(parentView, parentIndex) {
        var t1 = document.createElement("spy-parent");
        this.rootEl = t1;
        t1 = $.ViewSpyParentComponent0__renderType;
        if (t1 == null) {
          t1 = $.appViewUtils.createRenderType$3("", C.ViewEncapsulation_0, C.List_uwZ);
          $.ViewSpyParentComponent0__renderType = t1;
        }
        this.setupComponentType$1(t1);
      },
      build$0: function() {
        var parentRenderNode, doc, t1, _text_2, t2, _text_5, _text_7, _anchor_9, _text_11, _anchor_12, subscription_0;
        parentRenderNode = this.initViewRoot$1(this.rootEl);
        doc = document;
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._spy_component_template$_el_0 = t1;
        J.set$className$x(t1, "parent");
        this.addShimC$1(this._spy_component_template$_el_0);
        t1 = S.createAndAppend(doc, "h2", this._spy_component_template$_el_0);
        this._spy_component_template$_el_1 = t1;
        this.addShimE$1(t1);
        _text_2 = doc.createTextNode("Spy Directive");
        this._spy_component_template$_el_1.appendChild(_text_2);
        t1 = S.createAndAppend(doc, "input", this._spy_component_template$_el_0);
        this._spy_component_template$_el_3 = t1;
        this.addShimC$1(t1);
        t1 = new O.DefaultValueAccessor(this._spy_component_template$_el_3, new O.closure0(), new O.closure1());
        this._DefaultValueAccessor_3_4 = t1;
        t1 = [t1];
        this._NgValueAccessor_3_5 = t1;
        t2 = new U.NgModel(null, null, null, null, false, null, null, null, null);
        t2._init$1(t1);
        this._NgModel_3_6 = t2;
        t2 = S.createAndAppend(doc, "button", this._spy_component_template$_el_0);
        this._spy_component_template$_el_4 = t2;
        this.addShimC$1(t2);
        _text_5 = doc.createTextNode("Add Hero");
        this._spy_component_template$_el_4.appendChild(_text_5);
        t2 = S.createAndAppend(doc, "button", this._spy_component_template$_el_0);
        this._spy_component_template$_el_6 = t2;
        this.addShimC$1(t2);
        _text_7 = doc.createTextNode("Reset Heroes");
        this._spy_component_template$_el_6.appendChild(_text_7);
        t2 = S.createAndAppend(doc, "p", this._spy_component_template$_el_0);
        this._spy_component_template$_el_8 = t2;
        this.addShimE$1(t2);
        t2 = $.$get$ngAnchor();
        _anchor_9 = t2.cloneNode(false);
        this._spy_component_template$_el_0.appendChild(_anchor_9);
        t1 = new V.ViewContainer(9, 0, this, _anchor_9, null, null, null);
        this._spy_component_template$_appEl_9 = t1;
        this._spy_component_template$_NgFor_9_7 = new R.NgFor(t1, null, null, null, new D.TemplateRef(t1, S.spy_component_template__viewFactory_SpyParentComponent1$closure()));
        t1 = S.createAndAppend(doc, "h4", this._spy_component_template$_el_0);
        this._spy_component_template$_el_10 = t1;
        this.addShimE$1(t1);
        _text_11 = doc.createTextNode("-- Spy Lifecycle Hook Log --");
        this._spy_component_template$_el_10.appendChild(_text_11);
        _anchor_12 = t2.cloneNode(false);
        this._spy_component_template$_el_0.appendChild(_anchor_12);
        t2 = new V.ViewContainer(12, 0, this, _anchor_12, null, null, null);
        this._appEl_12 = t2;
        this._NgFor_12_7 = new R.NgFor(t2, null, null, null, new D.TemplateRef(t2, S.spy_component_template__viewFactory_SpyParentComponent2$closure()));
        J.addEventListener$3$x($.appViewUtils.get$eventManager(), this._spy_component_template$_el_3, "keyup.enter", this.eventHandler0$1(this.ctx.get$addHero()));
        J._addEventListener$3$x(this._spy_component_template$_el_3, "input", this.eventHandler1$1(this.get$_handle_input_3_2()), null);
        J._addEventListener$3$x(this._spy_component_template$_el_3, "blur", this.eventHandler0$1(this._DefaultValueAccessor_3_4.get$touchHandler()), null);
        t1 = this._NgModel_3_6._update;
        t1.toString;
        subscription_0 = new P._BroadcastStream(t1, [H.getTypeArgumentByIndex(t1, 0)]).listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_3_0()));
        J._addEventListener$3$x(this._spy_component_template$_el_4, "click", this.eventHandler0$1(this.ctx.get$addHero()), null);
        J._addEventListener$3$x(this._spy_component_template$_el_6, "click", this.eventHandler0$1(J.get$reset$x(this.ctx)), null);
        this.init$2(C.List_empty, [subscription_0]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_DefaultValueAccessor_EOZ && 3 === nodeIndex)
          return this._DefaultValueAccessor_3_4;
        if (token === C.OpaqueToken_NgValueAccessor && 3 === nodeIndex)
          return this._NgValueAccessor_3_5;
        if ((token === C.Type_NgModel_qx4 || token === C.Type_NgControl_GNi) && 3 === nodeIndex)
          return this._NgModel_3_6;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, t1, currVal_1, currVal_2;
        _ctx = this.ctx;
        t1 = this.viewData._cdState;
        this._NgModel_3_6.set$model(_ctx.get$newName());
        this._NgModel_3_6.ngAfterChanges$0();
        if (t1 === 0) {
          t1 = this._NgModel_3_6;
          X.setUpControl(t1._control, t1);
          t1._control.updateValueAndValidity$1$emitEvent(false);
        }
        currVal_1 = _ctx.get$heroes();
        if (this._expr_1 !== currVal_1) {
          this._spy_component_template$_NgFor_9_7.set$ngForOf(currVal_1);
          this._expr_1 = currVal_1;
        }
        this._spy_component_template$_NgFor_9_7.ngDoCheck$0();
        currVal_2 = _ctx.get$logs();
        if (this._expr_2 !== currVal_2) {
          this._NgFor_12_7.set$ngForOf(currVal_2);
          this._expr_2 = currVal_2;
        }
        this._NgFor_12_7.ngDoCheck$0();
        this._spy_component_template$_appEl_9.detectChangesInNestedViews$0();
        this._appEl_12.detectChangesInNestedViews$0();
      },
      destroyInternal$0: function() {
        var t1 = this._spy_component_template$_appEl_9;
        if (!(t1 == null))
          t1.destroyNestedViews$0();
        t1 = this._appEl_12;
        if (!(t1 == null))
      ...
      _handle_ngModelChange_3_0$1: [function($$event) {
        this.ctx.set$newName($$event);
      }, "call$1", "get$_handle_ngModelChange_3_0", 2, 0, 4],
      _handle_input_3_2$1: [function($$event) {
        var t1, t2;
        t1 = this._DefaultValueAccessor_3_4;
        t2 = J.get$value$x(J.get$target$x($$event));
        t1.onChange.call$1(t2);
      }, "call$1", "get$_handle_input_3_2", 2, 0, 4],
      static: {
        ViewSpyParentComponent0$: function(parentView, parentIndex) {
          var t1 = new S.ViewSpyParentComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, P.LinkedHashMap__makeEmpty(), parentView, null, null, null);
          t1.viewData = S.AppViewData_AppViewData(t1, 3, C.ViewType_1, parentIndex);
          t1.ViewSpyParentComponent0$2(parentView, parentIndex);
          return t1;
        }
      }
    },
    _ViewSpyParentComponent1: {
      "^": "AppView;_spy_component_template$_el_0,_spy_component_template$_SpyDirective_0_4,_spy_component_template$_text_1,_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        t1 = doc.createElement("div");
        ...
        this.addShimC$1(this._spy_component_template$_el_0);
        t1 = this.parentView;
        this._spy_component_template$_SpyDirective_0_4 = new F.SpyDirective(t1.parentView.injectorGet$2(C.Type_LoggerService_4CA, t1.viewData.parentIndex));
        t1 = doc.createTextNode("");
        this._spy_component_template$_text_1 = t1;
        this._spy_component_template$_el_0.appendChild(t1);
        this.init0$1(this._spy_component_template$_el_0);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        var t1;
        if (token === C.Type_SpyDirective_w2Y)
          ...
          t1 = false;
        if (t1)
          return this._spy_component_template$_SpyDirective_0_4;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var t1, local_hero, t2, currVal_0;
        t1 = this.viewData._cdState;
        local_hero = this.locals.$index(0, "$implicit");
        if (t1 === 0) {
          t1 = this._spy_component_template$_SpyDirective_0_4._spy_directive$_logger;
          t2 = $._nextId0;
          $._nextId0 = t2 + 1;
          t1.log$1("Spy #" + t2 + " onInit");
        }
        currVal_0 = Q.interpolate0(local_hero);
        if (this._expr_0 !== currVal_0) {
          this._spy_component_template$_text_1.textContent = currVal_0;
    ...
    _ViewSpyParentComponent2: {
      "^": "AppView;_spy_component_template$_el_0,_spy_component_template$_text_1,_expr_0,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var doc, t1;
        doc = document;
        t1 = doc.createElement("div");
    ...
    _ViewSpyParentComponentHost0: {
      "^": "AppView;_spy_component_template$_compView_0,_spy_component_template$_LoggerService_0_4,_SpyParentComponent_0_5,viewData,locals,parentView,componentType,rootEl,ctx",
      build$0: function() {
        var t1, t2, t3;
        t1 = S.ViewSpyParentComponent0$(this, 0);
        this._spy_component_template$_compView_0 = t1;
        this.rootEl = t1.rootEl;
        t2 = new D.LoggerService([], "", 1);
        this._spy_component_template$_LoggerService_0_4 = t2;
        t2 = new X.SpyParentComponent(t2, "Herbie", ["Windstorm", "Magneta"]);
        this._SpyParentComponent_0_5 = t2;
        t3 = this.viewData.projectableNodes;
        t1.ctx = t2;
        t1.viewData.projectableNodes = t3;
        t1.build$0();
        this.init0$1(this.rootEl);
        return new D.ComponentRef(this, 0, this.rootEl, this._SpyParentComponent_0_5);
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_LoggerService_4CA && 0 === nodeIndex)
          return this._spy_component_template$_LoggerService_0_4;
        if (token === C.Type_SpyParentComponent_Rss && 0 === nodeIndex)
          return this._SpyParentComponent_0_5;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        this._spy_component_template$_compView_0.detectChanges$0();
      },
      destroyInternal$0: function() {
        var t1 = this._spy_component_template$_compView_0;
        if (!(t1 == null))
          t1.destroy$0();
      }
    }
  }], ["", "package:lifecycle_hooks/src/spy_directive.dart",, F, {
    "^": "",
    SpyDirective: {
      "^": "Object;_spy_directive$_logger"
    }
  }], ["", "package:lifecycle_hooks/src/spy_directive.template.dart",, F, {
    "^": "",
  ...
  C.ComponentFactory_2No = new D.ComponentFactory("do-check", M.do_check_component_template__viewFactory_DoCheckComponentHost0$closure(), C.List_empty, [Q.DoCheckComponent]);
  C.ComponentFactory_ClA = new D.ComponentFactory("peek-a-boo", X.peek_a_boo_component_template__viewFactory_PeekABooComponentHost0$closure(), C.List_empty, [S.PeekABooComponent]);
  C.ComponentFactory_G5K = new D.ComponentFactory("after-view", S.after_view_component_template__viewFactory_AfterViewComponentHost0$closure(), C.List_empty, [K.AfterViewComponent]);
  C.ComponentFactory_GC3 = new D.ComponentFactory("after-view-parent", S.after_view_component_template__viewFactory_AfterViewParentComponentHost0$closure(), C.List_empty, [K.AfterViewParentComponent]);
  ...
  C.ComponentFactory_H1k = new D.ComponentFactory("on-changes", S.on_changes_component_template__viewFactory_OnChangesComponentHost0$closure(), C.List_empty, [D.OnChangesComponent]);
  C.ComponentFactory_MUB = new D.ComponentFactory("my-child", V.after_content_component_template__viewFactory_ChildComponentHost0$closure(), C.List_empty, [Z.ChildComponent]);
  C.ComponentFactory_TH2 = new D.ComponentFactory("on-changes-parent", S.on_changes_component_template__viewFactory_OnChangesParentComponentHost0$closure(), C.List_empty, [D.OnChangesParentComponent]);
  C.ComponentFactory_WRd = new D.ComponentFactory("after-content-parent", V.after_content_component_template__viewFactory_AfterContentParentComponentHost0$closure(), C.List_empty, [Z.AfterContentParentComponent]);
  C.ComponentFactory_c9P = new D.ComponentFactory("spy-parent", S.spy_component_template__viewFactory_SpyParentComponentHost0$closure(), C.List_empty, [X.SpyParentComponent]);
  C.ComponentFactory_cWU = new D.ComponentFactory("my-child-view", S.after_view_component_template__viewFactory_ChildViewComponentHost0$closure(), C.List_empty, [K.ChildViewComponent]);
  C.ComponentFactory_hk6 = new D.ComponentFactory("do-check-parent", M.do_check_component_template__viewFactory_DoCheckParentComponentHost0$closure(), C.List_empty, [Q.DoCheckParentComponent]);
  C.ComponentFactory_lRY = new D.ComponentFactory("counter-parent", F.counter_component_template__viewFactory_CounterParentComponentHost0$closure(), C.List_empty, [D.CounterParentComponent]);
  C.ComponentFactory_nBh = new D.ComponentFactory("peek-a-boo-parent", A.peek_a_boo_parent_component_template__viewFactory_PeekABooParentComponentHost0$closure(), C.List_empty, [V.PeekABooParentComponent]);
  C.ComponentFactory_qJr = new D.ComponentFactory("my-counter", F.counter_component_template__viewFactory_MyCounterComponentHost0$closure(), C.List_empty, [D.MyCounterComponent]);
  C.ComponentFactory_wuX = new D.ComponentFactory("after-content", V.after_content_component_template__viewFactory_AfterContentComponentHost0$closure(), C.List_empty, [Z.AfterContentComponent]);
...
;
  ...
  C.List_0Zn = Isolate.makeConstantList([".parent._ngcontent-%COMP% { background:gold; }"]);
  ...
  C.List_EGJ = Isolate.makeConstantList([".counter._ngcontent-%COMP% { background:lightyellow; padding:8px; margin-top:8px; }"]);
  ...
  C.List_MuZ = Isolate.makeConstantList([".parent._ngcontent-%COMP% { background:lavender; }"]);
  C.List_MuZ0 = Isolate.makeConstantList([".parent._ngcontent-%COMP% { background:moccasin; }"]);
  C.List_PPN = Isolate.makeConstantList([".hero._ngcontent-%COMP% { background:lightyellow; padding:8px; margin-top:8px; }", "p._ngcontent-%COMP% { background:yellow; padding:8px; margin-top:8px; }"]);
  ...
  C.List_uwZ = Isolate.makeConstantList([".parent._ngcontent-%COMP% { background:khaki; }", ".heroes._ngcontent-%COMP% { background:lightyellow; padding:0 8px; }"]);
  C.List_y5f = Isolate.makeConstantList([".parent._ngcontent-%COMP% { background:burlywood; }"]);
  ...
  C.List_ypT = Isolate.makeConstantList(["p._ngcontent-%COMP% { background:lightyellow; padding:8px; }"]);
  ...
  C.Type_AfterContentComponent_gc6 = H.createRuntimeType("AfterContentComponent");
  C.Type_AfterContentParentComponent_iDZ = H.createRuntimeType("AfterContentParentComponent");
  C.Type_AfterViewComponent_RTB = H.createRuntimeType("AfterViewComponent");
  C.Type_AfterViewParentComponent_zvB = H.createRuntimeType("AfterViewParentComponent");
  C.Type_AppComponent_TyU = H.createRuntimeType("AppComponent");
  C.Type_ChildComponent_kaS = H.createRuntimeType("ChildComponent");
  C.Type_ChildViewComponent_ctK = H.createRuntimeType("ChildViewComponent");
  C.Type_CounterParentComponent_OvD = H.createRuntimeType("CounterParentComponent");
  C.Type_DefaultValueAccessor_EOZ = H.createRuntimeType("DefaultValueAccessor");
  C.Type_DoCheckComponent_IGs = H.createRuntimeType("DoCheckComponent");
  C.Type_DoCheckParentComponent_8FR = H.createRuntimeType("DoCheckParentComponent");
  ...
  C.Type_LoggerService_4CA = H.createRuntimeType("LoggerService");
  C.Type_MyCounterComponent_f7L = H.createRuntimeType("MyCounterComponent");
  C.Type_NgControl_GNi = H.createRuntimeType("NgControl");
  C.Type_NgModel_qx4 = H.createRuntimeType("NgModel");
  C.Type_OnChangesComponent_EOZ = H.createRuntimeType("OnChangesComponent");
  C.Type_OnChangesParentComponent_mBr = H.createRuntimeType("OnChangesParentComponent");
  C.Type_PeekABooComponent_Q3l = H.createRuntimeType("PeekABooComponent");
  C.Type_PeekABooParentComponent_PPf = H.createRuntimeType("PeekABooParentComponent");
  ...
  C.Type_SpyDirective_w2Y = H.createRuntimeType("SpyDirective");
  C.Type_SpyParentComponent_Rss = H.createRuntimeType("SpyParentComponent");
  ...
  $._visited0 = false;
  $.ViewChildComponent0__renderType = null;
  $.ViewAfterContentComponent0__renderType = null;
  $.ViewAfterContentParentComponent0__renderType = null;
  $._visited35 = false;
  $.ViewChildViewComponent0__renderType = null;
  $.ViewAfterViewComponent0__renderType = null;
  $.ViewAfterViewParentComponent0__renderType = null;
  $._visited34 = false;
  $.ViewMyCounterComponent0__renderType = null;
  $.ViewCounterParentComponent0__renderType = null;
  $._visited33 = false;
  $.ViewDoCheckComponent0__renderType = null;
  $.ViewDoCheckParentComponent0__renderType = null;
  $._visited32 = false;
  $._visited28 = false;
  $.ViewOnChangesComponent0__renderType = null;
  $.ViewOnChangesParentComponent0__renderType = null;
  $._visited31 = false;
  $._nextId = 1;
  $.ViewPeekABooComponent0__renderType = null;
  $._visited30 = false;
  $.ViewPeekABooParentComponent0__renderType = null;
  $._visited29 = false;
  $.ViewSpyParentComponent0__renderType = null;
  $._visited1 = false;
  $._nextId0 = 1;
  $._visited2 = false;
  $._visited = false;
  ...
  (function(lazies) {
    ...
    return P.LinkedHashMap__makeLiteral(["alt", new N.closure3(), "control", new N.closure4(), "meta", new N.closure5(), "shift", new N.closure6()]);
  }, "modifierKeyGetters"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = ["index", "self", "parent", "zone", "_", null, "error", "stackTrace", "p0", "value", "fn", "arg", "result", "callback", "o", "p1", "elem", "arg1", "arg2", "f", "invocation", "data", "findInAncestors", "x", "arguments", "object", "p2", "event", "e", "name", "element", "arg3", "k", "v", "closure", "each", "isolate", "captureThis", "zoneValues", "numberOfArguments", "ref", "eventObj", "key", "sender", "specification", "item", "errorCode", "t", "theError", "trace", "duration", "clazz", "deps", "stack", "reason", "arg4", "binding", "exactMatch", true, "theStackTrace", "didWork_", "newList", "err"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, v: true, args: [,]}, {func: 1, args: [,,]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Function]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: [S.AppView, V.PeekABooParentComponent], args: [S.AppView, P.num]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, ret: W.Element, args: [P.int]}, {func: 1, ret: W.Node, args: [P.int]}, {func: 1, ret: W.MimeType, args: [P.int]}, {func: 1, ret: P.Future}, {func: 1, ret: P.String}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: [S.AppView, X.SpyParentComponent], args: [S.AppView, P.num]}, {func: 1, args: [P.String, A.SimpleChange]}, {func: 1, ret: [S.AppView, Z.AfterContentParentComponent], args: [S.AppView, P.num]}, {func: 1, ret: [S.AppView, K.AfterViewParentComponent], args: [S.AppView, P.num]}, {func: 1, ret: W.Touch, args: [P.int]}, {func: 1, ret: W.SpeechGrammar, args: [P.int]}, {func: 1, ret: W.SpeechRecognitionAlternative, args: [P.int]}, {func: 1, args: [P.String,,]}, {func: 1, ret: W.TrackDefault, args: [P.int]}, {func: 1, ret: W.VttRegion, args: [P.int]}, {func: 1, ret: P.Rectangle, args: [P.int]}, {func: 1, ret: W.CssRule, args: [P.int]}, {func: 1, ret: W.Gamepad, args: [P.int]}, {func: 1, ret: W._Attr, args: [P.int]}, {func: 1, ret: W.SpeechRecognitionResult, args: [P.int]}, {func: 1, ret: W.StyleSheet, args: [P.int]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, v: true, opt: [P.Object]}, {func: 1, ret: P.Map, args: [P.int]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, args: [R.CollectionChangeRecord, P.int, P.int]}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [, P.String]}, {func: 1, ret: W.DataTransferItem, args: [P.int]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: P.bool}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, args: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, ret: P.Object, opt: [P.Object]}, {func: 1, args: [V.HammerGestureConfig]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, args: [,], named: {rawValue: P.String}}, {func: 1, args: [Z.AbstractControl]}, {func: 1, ret: W.File, args: [P.int]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.Object, args: [,]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: [S.AppView, Z.AfterContentComponent], args: [S.AppView, P.num]}, {func: 1, ret: W.Plugin, args: [P.int]}, {func: 1, ret: [S.AppView, K.AfterViewComponent], args: [S.AppView, P.num]}, {func: 1, ret: [P.List, W.RtcStatsReport]}, {func: 1, ret: [S.AppView, D.MyCounterComponent], args: [S.AppView, P.num]}, {func: 1, ret: [S.AppView, D.CounterParentComponent], args: [S.AppView, P.num]}, {func: 1, ret: [S.AppView, Q.DoCheckComponent], args: [S.AppView, P.num]}, {func: 1, ret: [S.AppView, D.OnChangesComponent], args: [S.AppView, P.num]}, {func: 1, ret: W.SourceBuffer, args: [P.int]}, {func: 1, args: [P.List, Y.NgZone]}];
