...
class ViewChildViewComponent0 extends AppView<import1.ChildViewComponent> {
  ...
  ViewChildViewComponent0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    rootEl = import2.document.createElement('my-child-view');
    _renderType ??= import8.appViewUtils.createRenderType('', ViewEncapsulation.None, styles$ChildViewComponent);
...
class _ViewChildViewComponentHost0 extends AppView<dynamic> {
  ...
  import1.ChildViewComponent _ChildViewComponent_0_4;
  _ViewChildViewComponentHost0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.HOST, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways);
  @override
  ComponentRef build() {
    _compView_0 = new ViewChildViewComponent0(this, 0);
    rootEl = _compView_0.rootEl;
    _ChildViewComponent_0_4 = new import1.ChildViewComponent();
    _compView_0.create(_ChildViewComponent_0_4, projectableNodes);
    init0(rootEl);
    return new ComponentRef<import1.ChildViewComponent>(0, this, rootEl, _ChildViewComponent_0_4);
  }

  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import1.ChildViewComponent) && (0 == nodeIndex))) {
      return _ChildViewComponent_0_4;
    }
    return notFoundResult;
  }
...
class ViewAfterViewComponent0 extends AppView<import1.AfterViewComponent> {
  final import13.QueryList _viewQuery_ChildViewComponent_0 = new import13.QueryList();
  import2.DivElement _el_0;
  import2.Element _el_2;
  ViewChildViewComponent0 _compView_2;
  import1.ChildViewComponent _ChildViewComponent_2_4;
  import2.DivElement _el_3;
  ViewContainer _appEl_5;
  NgIf _NgIf_5_7;
  static RenderComponentType _renderType;
  ViewAfterViewComponent0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    rootEl = import2.document.createElement('after-view');
    _renderType ??= import8.appViewUtils.createRenderType('', ViewEncapsulation.None, styles$AfterViewComponent);
    setupComponentType(_renderType);
  }
  @override
  ComponentRef<import1.AfterViewComponent> build() {
    ...
    _ChildViewComponent_2_4 = new import1.ChildViewComponent();
    _compView_2.create(_ChildViewComponent_2_4, []);
    ...
    TemplateRef _TemplateRef_5_6 = new TemplateRef(_appEl_5, viewFactory_AfterViewComponent1);
    _NgIf_5_7 = new NgIf(_appEl_5, _TemplateRef_5_6);
    _viewQuery_ChildViewComponent_0.reset([_ChildViewComponent_2_4]);
    ctx.viewChild = _viewQuery_ChildViewComponent_0.first;
    init(const [], null);
    return null;
  }
  ...
  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import1.ChildViewComponent) && (2 == nodeIndex))) {
      return _ChildViewComponent_2_4;
    }
    return notFoundResult;
  }
  ...
  void detectChangesInternal() {
    ...
    _NgIf_5_7.ngIf = _ctx.comment.isNotEmpty;
...
class _ViewAfterViewComponent1 extends AppView<import1.AfterViewComponent> {
  ...
  var _expr_0;
  _ViewAfterViewComponent1(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.EMBEDDED, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
...
class _ViewAfterViewComponentHost0 extends AppView<dynamic> {
  ...
  import1.AfterViewComponent _AfterViewComponent_0_4;
  _ViewAfterViewComponentHost0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.HOST, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways);
  @override
  ComponentRef build() {
    _compView_0 = new ViewAfterViewComponent0(this, 0);
    rootEl = _compView_0.rootEl;
    _AfterViewComponent_0_4 = new import1.AfterViewComponent(this.injectorGet(import17.LoggerService, viewData.parentIndex));
    _compView_0.create(_AfterViewComponent_0_4, projectableNodes);
    init0(rootEl);
    return new ComponentRef<import1.AfterViewComponent>(0, this, rootEl, _AfterViewComponent_0_4);
  }

  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import1.AfterViewComponent) && (0 == nodeIndex))) {
      return _AfterViewComponent_0_4;
    }
    return notFoundResult;
  }
  ...
  void detectChangesInternal() {
    ...
    _compView_0.detectChanges();
    if (firstCheck) {
      _AfterViewComponent_0_4.ngAfterViewInit();
    }
    _AfterViewComponent_0_4.ngAfterViewChecked();
  }
...
class ViewAfterViewParentComponent0 extends AppView<import1.AfterViewParentComponent> {
  ...
  var _expr_1;
  static RenderComponentType _renderType;
  ViewAfterViewParentComponent0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.COMPONENT, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    rootEl = import2.document.createElement('after-view-parent');
    _renderType ??= import8.appViewUtils.createRenderType('', ViewEncapsulation.Emulated, styles$AfterViewParentComponent);
    setupComponentType(_renderType);
  }
  @override
  ComponentRef<import1.AfterViewParentComponent> build() {
    ...
    TemplateRef _TemplateRef_3_6 = new TemplateRef(_appEl_3, viewFactory_AfterViewParentComponent1);
    ...
    TemplateRef _TemplateRef_9_6 = new TemplateRef(_appEl_9, viewFactory_AfterViewParentComponent2);
...
class _ViewAfterViewParentComponent1 extends AppView<import1.AfterViewParentComponent> {
  ...
  ViewAfterViewComponent0 _compView_0;
  import1.AfterViewComponent _AfterViewComponent_0_4;
  _ViewAfterViewParentComponent1(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.EMBEDDED, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
  ...
  ComponentRef<import1.AfterViewParentComponent> build() {
    ...
    addShimC(_el_0);
    _AfterViewComponent_0_4 = new import1.AfterViewComponent(parentView.parentView.injectorGet(import17.LoggerService, parentView.viewData.parentIndex));
    _compView_0.create(_AfterViewComponent_0_4, []);
    init0(_el_0);
    return null;
  }
...
class _ViewAfterViewParentComponent2 extends AppView<import1.AfterViewParentComponent> {
  ...
  import2.Text _text_1;
  var _expr_0;
  _ViewAfterViewParentComponent2(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.EMBEDDED, {'\$implicit': null}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways) {
    componentType = ViewAfterViewParentComponent0._renderType;
  }
  @override
  ComponentRef<import1.AfterViewParentComponent> build() {
...
class _ViewAfterViewParentComponentHost0 extends AppView<dynamic> {
  ...
  import1.AfterViewParentComponent _AfterViewParentComponent_0_5;
  _ViewAfterViewParentComponentHost0(AppView<dynamic> parentView, num parentIndex) : super(import6.ViewType.HOST, {}, parentView, parentIndex, ChangeDetectionStrategy.CheckAlways);
  @override
  ComponentRef build() {
    _compView_0 = new ViewAfterViewParentComponent0(this, 0);
    rootEl = _compView_0.rootEl;
    _LoggerService_0_4 = new import17.LoggerService();
    _AfterViewParentComponent_0_5 = new import1.AfterViewParentComponent(_LoggerService_0_4);
    _compView_0.create(_AfterViewParentComponent_0_5, projectableNodes);
    init0(rootEl);
    return new ComponentRef<import1.AfterViewParentComponent>(0, this, rootEl, _AfterViewParentComponent_0_5);
  }
  ...
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    ...
    if ((identical(token, import1.AfterViewParentComponent) && (0 == nodeIndex))) {
      return _AfterViewParentComponent_0_5;
    }
    return notFoundResult;
  }
...
void initReflector() {
  ...
  _ngRef.registerComponent(
    ChildViewComponent,
    ChildViewComponentNgFactory,
  );
  _ngRef.registerComponent(
    AfterViewComponent,
    AfterViewComponentNgFactory,
  );
  _ngRef.registerComponent(
    AfterViewParentComponent,
    AfterViewParentComponentNgFactory,
  );
}
